...
import {
  ...
  location6PageTitle,
  location1PayrentPageTitle,
  location1PayrentPageContent,
  location2PayrentPageTitle,
  location2PayrentPageContent,
  location3PayrentPageTitle,
  location3PayrentPageContent,
  location4PayrentPageTitle,
  location4PayrentPageContent,
  location5PayrentPageTitle,
  location5PayrentPageContent,
  location6PayrentPageTitle,
  location6PayrentPageContent,
  location1ContactPageTitle,
  location1ContactPageContent,
  location2ContactPageTitle,
  location2ContactPageContent,
  location3ContactPageTitle,
  location3ContactPageContent,
  location4ContactPageTitle,
  location4ContactPageContent,
  location5ContactPageTitle,
  location5ContactPageContent,
  location6ContactPageTitle,
  location6ContactPageContent,
} from "../data/title";
...
export const location5 = `woodland`;
...
export const urlLocation5 = `${environment.websiteUrl}/${environment.locationName}/woodland/storage-units`;
...
export const description5 = `Our Woodland location has a number of unit sizes ideal for just about any self storage
...
export const Location1Script = {
  ...
  paymentAccepted:
    "Cash, Check, Credit Card, Debit Card, Online Credit Card, Online Debit Card",
  areaServed: {
    "@type": "State",
    name: "New York",
  },

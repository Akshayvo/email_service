...
export const serviceOffered = [
  ...
  {
    p3: `In-N-Out Storage takes to heart the solid foundation provided by its involvement in community activities for the City of Plymouth and surrounding communities. We are proud and honored to be able to give support for community activities, including local teams, youth events, churches, and various community activities.`,
  },
];
...
export const storagePoints = [
  ...
  {
    data: "RV/Trailer/Boat Parking - large outdoor parking stalls available to accommodate any size RV, trailer, camper, or boat.",
  },
  //   {
  ...
  {
    data: "Sanitary dump station available to all In-N-Out customers, at no charge.",
  },

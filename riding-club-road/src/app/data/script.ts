...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Riding_Club_Road/jpg/riding-club-mini-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Riding_Club_Road/jpg/riding-club-mini-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Riding_Club_Road/jpg/riding-club-mini-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/wGQ9AL5MSTz9QE9B9",
     description: "Rockwall Storage is conveniently located on Riding Club Rd in the heart of Rockwall County. We are a family owned and operated self storage and vehicle parking facility, and we are proud to have served our friends and neighbors in Rockwall, Royse City, Blackland, and the surrounding communities since 1995. We are committed to providing affordable, clean, well-maintained self storage units with the quality customer service only a locally owned and operated business can offer!",
     streetAddress: "2416 Riding Club Rd",
     state: "Texas",

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Wellesley_Self_Storage/jpg/stock-self-storage-11%20%281%29.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Wellesley_Self_Storage/jpg/stock-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Wellesley_Self_Storage/jpg/stock-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/nTLdsUyLrJBX2A6e8",
     description: "",
     streetAddress: "1287 Hutchison RdWellesley",
     state: "Ontario",
     ...
     bestRating: "5",
     reviewCount: "",
     latitude: 43.475869046096356,
     longitude: -80.78188527782936,
     openingHours: [],
     priceRange: ''
};

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
     ...
     description: "Stor-Right Storage offers convenient 24/7 access to your belongings,online payments and a variety of unit sizes for all of your self storage needs.",
     streetAddress: "806 S 48th Ave, Wausau, WI 54401",
     state: "marathon",

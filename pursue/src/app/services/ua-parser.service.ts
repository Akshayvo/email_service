...
export class UaParserService {
  ...
  determineBaseUrl() {
    ...
    if (this.typeOfImages === 'WEBP') {
      this.baseUrl = `https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Pursue_Images/webp`;
    } else {
      this.baseUrl = 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Pursue_Images/jpg';
    }
  }
}

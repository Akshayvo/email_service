...
export const viewRatesPageTitle = `Parking Rates | Pursue SeRVice & Storage`;
...
export const payRentPageTitle = `Pay Rent | Pursue SeRVice & Storage`;
...
export const contactPageTitle = `Contact Us | Pursue SeRVice & Storage`;
...
export const thankYouPageTitle = `Thank You For Reserving Your Unit at Pursue SeRVice & Storage!`;
export const thankYouPageContent = `We've received your reservation! One of our friendly staff will be in touch!`;

export const privacyPolicyPageTitle = `Privacy Policy | Pursue SeRVice & Storage`;
...
export const serviceCenterPageTitle = ` Service Center | Pursue SeRVice & Storage`;

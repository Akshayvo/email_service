...
export const apiRoutes = [
    ...
    { path: 'review/mcKenzie', component: HomeComponent,
    resolve: {
    ...
    { path: 'review/huntingdon', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  { path: 'review/airport', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  {
    path: 'pay-rent/mcKenzie', component: PayRentComponent,
    children: childroute
  },
  {
    path: 'pay-rent/huntingdon', component: PayRentComponent,
    children: childroute
  },
  {
    path: 'pay-rent/airport', component: PayRentComponent,
    children: childroute
  },

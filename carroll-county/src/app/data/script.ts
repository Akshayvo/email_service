...
export const urlLocation1 = `${environment.websiteUrl}/location/mcKenzie/storage-units`;
export const urlLocation2 = `${environment.websiteUrl}/location/huntingdon/storage-units`;
export const urlLocation3 = `${environment.websiteUrl}/location/airport/storage-units`;

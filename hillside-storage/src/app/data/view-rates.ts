...
export const dataViewRates = [
    {
      p: `Hillside Self Storage is well-lit and has extra-wide parking areas to make parking and navigating
      between other tenants extremely easy! Our brand new units are clean, well-maintained, and affordably
      priced to match any budget! Take a moment to review our rates and don’t hesitate to give our friendly
      and professional management team a call! We are happy to get you started on your storage journey, today!`,
    },
    
];

export const viewRatesAltText = `metal storage unit buildings with green roll up doors, gravel parking area and trees in the background`;

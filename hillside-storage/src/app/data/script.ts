...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/HillSide_Images/jpg/hillside-self-storage-buildings.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/HillSide_Images/jpg/hillside-self-storage-buildings.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/HillSide_Images/jpg/hillside-self-storage-buildings.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/Dk2msnijgAjQuW9a9",
     description: "Hillside Self Storage offers convenient 24/7 access to your belongings,online payments and a variety of unit sizes for all of your self storage needs. ",
     streetAddress: "69 Old Mason Center Rd",
     state: "New Hampshire",
     ...
     latitude: 42.76581,
     longitude: -71.788714,
     openingHours: ["Mon-Sun:9:00AM-5:00PM"],
     priceRange: '$60-$190'
};

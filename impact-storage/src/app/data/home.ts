...
export const serviceOffered = [
    {
        p: `Impact Self Storage serves Scotrun with a number of clean, well-maintained, and affordable self storage sizes. We offer a number of conveniences to make your next move, renovation, or spring cleaning project an easy and affordable one. Take a moment to check out our current availability and rates, then rent your unit online in minutes with our easy online application!`,
    },
];

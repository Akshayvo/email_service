...
export const apiRoutes = [
    ...
    { path: 'review/scotrun', component: HomeComponent,
    resolve: {
  ...
  {
    path: 'pay-rent/scotrun', component: PayRentComponent,
    children: childroute
  },
  ...
  { path: 'contact-scotrun', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-scotrun', component: PayRentFloridaComponent },
  { path: `${environment.locationName}/storage-tips`, component: StorageTipsComponent },
  { path: 'contact-us', component: ContactComponent },
  { path: '**', component: ErrorComponent },
];

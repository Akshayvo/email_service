...
export const headingReservePageLocation1 = `Are you ready to rent a unit at Scotrun`;
...
export const heading1 = `Impact Self Storage - Scotrun`;
...
export const unitSizerLocation1 = [
    ...
    {
        text: '5\' x 7\' Storage Unit',
        alt: '5\' x 7\' Storage Unit Graphic ',
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/5x10.png',
        data: `This unit is approximately 35 sq feet of space that can hold the contents of one small room, such as:
        `,
        amenities: [
            { content: 'Chairs', },
            { content: 'Small Desks', },

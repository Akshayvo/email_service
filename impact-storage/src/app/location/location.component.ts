...
import { heading1,  tabs,  } from '../data/location';
import { Title, Meta } from '@angular/platform-browser';
import { WINDOW } from '@ng-toolkit/universal';
import { DataSharingService } from '../api-bundle/services/data-sharing.service';
import { CanonicalService } from '../services/canonical.service';
import { Location1Script, ogLocation1,  twitterLocation1,
   } from '../data/script';
import { featuresHead, featuresList, location1FeaturesHead, 
   } from '../data/home';
...
id = 3;
  ...
  constructor(
    ...
    this.titleService.setTitle(`${this.location1PageTitle}`);
            this.locationName = `Impact Self Storage - Scotrun`;
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/scotrun/reserve-unit`],
          );
  } 

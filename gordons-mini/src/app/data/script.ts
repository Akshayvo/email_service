...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Gordans_Mini_Storage/jpg/gordons-mini-storage-jumbotron1.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Gordans_Mini_Storage/jpg/gordons-mini-storage-jumbotron1.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Gordans_Mini_Storage/jpg/gordons-mini-storage-jumbotron1.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://g.page/gordonsministorage?share",
     description: "Are you in search of affordable self storage units near Kelso,WA? Gordon's Mini Storage has a wide variety of convenient sizes and excellent customer service!",
     streetAddress: "1712 Westside Hwy",
     state: "Washington",
     ...
     bestRating: "5",
     reviewCount: "60",
     latitude: 46.19092697,
     longitude: -122.90075,
     openingHours: ["Tue-Frid:9:00AM-5PM"],
     priceRange: '$49-$259'
};

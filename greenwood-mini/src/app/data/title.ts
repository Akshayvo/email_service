export const homePageTitle = `Affordable Regular & Climate Controlled Self Storage in Greenwood, MS`;
export const homePageContent = `Greenwood Mini-Storage serves  and the surrounding communities with a variety of well-maintained and affordable self storage units`;
...
export const payRentPageTitle = `Pay Rent  | Greenwood Mini-Storage`;
...
export const storageTipsTitle = `Storage Tips  | Greenwood Mini-Storage`;
export const storageTipsContent = `Follow these easy self storage tips to make your stay with Greenwood Mini-Storage a breeze! Have questions? Call today!`;

...
export const jumbotron = [
  {
    ...
    blurb: `Greenwood Mini-Storage offers 3 convenient self storage facilities in Greenwood Mississippi that are ideal solutions to your storage space needs. Take a moment to review the rates and availability at each of our well-lit, fully-fenced locations, then rent your unit online in minutes with our easy tenant portal! We look forward to making your next storage project easy and affordable!`,
  },
];

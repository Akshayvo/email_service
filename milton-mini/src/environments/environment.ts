...
export const environment = {
  ...
  locationName: 'Carolina/Perry', // state/city  **Remeber to update locationName in sitemap.xml as well
  ...
  // APIKey: `dzJ0OVc0SjYqMk46MjJ8JTg3ODc3JCg4PWJXMHNoZGQ5a2VvY15O`, // 12799 

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Milton_Mini/schema/milton-ministorage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Milton_Mini/schema/milton-ministorage-169.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Milton_Mini/schema/milton-ministorage-43.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/pcipVdGcqANGpuaK9",
     description: "Milton Mini Storage is Milton's one stop self storage solution. Our brand new self storage facility is conveniently located in the Perry Morris Square at the heart of downtown Milton, West Virginia. Our brand new self storage facility is built from the ground up to make your next self storage project a fast and easy one.",

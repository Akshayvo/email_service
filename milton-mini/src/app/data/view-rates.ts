...
export const dataViewRates = [
    {
      p: `Take a moment to review our prices and current unit availability, then rent your unit online in 
      minutes. You'll receive an electronic lease agreement in just a few minutes. Once that's signed, 
      a confirmation email will include your unique pin-code. It's as easy as that!`,
    },
    {
      p: `Once you're a tenant at Milton Mini Storage, you'll have 24-hour access to your unit as well 
      as your account. You can log in to check your balance or pay your rent at your conveneince.`
    },
    {
      p: `Still have questions? Give us a call!`
    },
];

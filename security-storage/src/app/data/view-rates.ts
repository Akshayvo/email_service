...
export const dataViewRates = [
    ...
    {
        p: `The office suites offered by Security STORAGE give many of our customers the ability to just "get out
        of the house" to get work done are leased in 6-month to 12-month increments.  Our office suites are the
        perfect solution if you're looking to bring some balance to the work/life equation. Call the office
        for office rates and availability.`,
    },
];

...
export const featuresList = [
    {
        td1: 'Access 7 Days a Week',
        td2: 'No Deposits',
    },
    {
        td1: 'Video Surveillance',
        td2: 'Secure Keypad Access',
    },
    {
...
export const gettingStarted = `Are you ready to start de-cluttering your home or office today? Get some of that
elbow room back by storing with High Falls Self Storage, LLC and our high-quality, affordable self storage units!`;

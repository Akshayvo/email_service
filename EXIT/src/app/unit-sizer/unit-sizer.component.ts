...
export class UnitSizerComponent implements OnInit {
  ...
  constructor(
    ...
    this.meta.addTag({
      name: 'description',
      content: `Having trouble figuring out what a self storage unit is capable of holding?
      Use this handy Unit Sizer to figure out what size you'll need!`
    });
    this.titleService.setTitle('Unit Sizer | Exit 120 Self Storage');
  }

export const featuresList = [
    ...
    },
    {
        ...
        td2: 'Temperature Controlled Units',
    },
    {
...
export const aboutUsAlt = `indoor Temperature controlled storage units with roll-up doors inside of a clean, well-lit building`;

export const aboutUsHeading = `Temperature controlled Self Storage Units in Charleston, W.V.`;
...
export const aboutUs = [
    ...
    {
        p: `Whether you’re a residential or commercial self storage user, our variety of temperature controlled storage unit sizes has you covered! Check out our rates or call today!`,
    }

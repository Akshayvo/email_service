...
export const viewRatesPageTitle = `View Rates | Storage Square`;
...
export const unitSizerPageTitle = `Unit Sizer | Storage Square`;
...
export const contactPageTitle = `Contact Us  | Storage Square`;
...
export const thankYouPageTitle = `Thank You For Reserving Your Unit at Storage Square!`;
export const thankYouPageContent = `We've received your reservation! One of our friendly staff will be in touch!`;

export const privacyPolicyPageTitle = `Privacy Policy | Storage Square`;

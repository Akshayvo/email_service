...
export const thankYouPageTitle = `Thank You For Reserving Your Unit at Catskill!`;
export const thankYouPageContent = `We've received your reservation! One of our friendly staff will be in touch!`;

export const privacyPolicyPageTitle = `Privacy Policy | Catskill Self Storage, Catskill, NY, 12414`;

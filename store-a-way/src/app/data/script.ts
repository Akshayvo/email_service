...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
     ...
     map: "",
     description: "Store-A-Way is Hamilton’s newest climate controlled self storage facility. We offer a number of clean, affordable, and climate controlled storage unit sizes perfect for any home, business, or college student searching for a little extra elbow room around the home, office, or dorm. ",
     streetAddress: "1030 Madison Market Place",
     state: "hamilton",

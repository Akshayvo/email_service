...
export const dataViewRates = [
    {
      p: `Our reasonable terms and competitive rates all come with the friendly hometown customer service you’ve 
      come to expect from locally owned and operated businesses. We are proud to serve our friends and neighbors 
      in Hamilton, Morrisville, Earlville, and surrounding communities in Madison County.`,
    },
    {
      p: `Take a moment to review our unit rates and current availability, then reserve your storage unit at Store-A-Way in 
      minutes with our online portal. Our friendly staff will reach out, and we’ll help you complete your 
      application over the phone. You’ll be clearing out that attic, garage, or dorm room in no time!`
    },
];

...
resolve: { data: AppResolver }
    ...
    { path: `${environment.locationName}/quitman-mini/view-rates`,
      component: LocationComponent,
      children: [
        {path: '', redirectTo: 'storage-units', pathMatch: 'full' },
        { path: 'storage-units', component: ViewRatesComponent },
      ...
      resolve: { data: AppResolver }
        ...
        { path: `${environment.locationName}/heber-springs/view-rates`,
      component: LocationComponent,
      children: [
        {path: '', redirectTo: 'storage-units', pathMatch: 'full' },
        { path: 'storage-units', component: ViewRatesComponent },
...
resolve: { data: AppResolver }
    ...
    { path: 'review/quitman-mini', component: HomeComponent,
    resolve: {
  ...
  { path: 'review/heber-springs', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  {
    path: 'pay-rent/quitman-mini', component: PayRentComponent,
    children: childroute
  },
   {
    path: 'pay-rent/heber-springs', component: PayRentComponent,
    children: childroute
  },
  {
  ...
  { path: 'contact-quitman-mini', component: ContactUsComponent},
  { path: 'contact-heber-springs', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-quitman-mini', component: PayRentFloridaComponent },

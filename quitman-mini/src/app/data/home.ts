...
export const aboutusHeading = `Affordable Storage Units in Heber Springs, AR`;
...
export const serviceOffered = [
    ...
    {
        p: `So whether you’re a local business that recognizes the value of storing equipment, inventory, and supplies off-site, or a residential user preparing for a move or renovation, give us a call today! We look forward to meeting your storage solution needs!`,
    },
];

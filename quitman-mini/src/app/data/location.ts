...
export const heading2 = `Heber Springs Xtra Storage`;
...
export const unitSizerLocation1 = [
    ...
    {
        text: '20\' x 20\' Storage Unit',
        alt: '20\' x 20\' Storage Unit Graphic',
    ...
    {
        text: '20\' x 30\' Storage Unit',
        alt: '20\' x 30\' Storage Unit Graphic',
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/15x42.png',
        data: `This unit is approximately 600sq feet of space that can store the contents of a large home, including.`,
        amenities: [
            { content: 'Appliances', },
            { content: 'Car or Small Boat', },
            { content: 'Furniture', },
    ...
    {
        text: '20\' x 40\' Storage Unit',
        alt: '20\' x 40\' Storage Unit Graphic',
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/15x42.png',
        data: `This unit is approximately 800sq feet of space that can store the contents of a large home, including.`,
        amenities: [
            { content: 'Appliances', },
            { content: 'Car or Small Boat', },
            { content: 'Furniture', },
...
export const unitSizerLocation2 = [
    ...
    {
        text: '12\' x 30\' Storage Unit',
        alt: '12\' x 30\' Storage Unit Graphic ',
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/15x42.png',
        data: `This unit is approximately 360sq feet of space that can store the contents of a large home, including.
        `,
        amenities: [
            { content: 'Appliances', },
            { content: 'Car or Small Boat', },

...
export class LocationComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.router.url.includes(`${environment.locationName}/quitman-mini`)) {
      ...
      this.locationName = `Quitman Mini Storage`;
      ...
      this.router.url.includes(`${environment.locationName}/heber-springs`)
    ) {
      this.meta.addTag({
        name: "description",
      ...
      this.locationName = `Heber Springs Xtra Storage`;
      this.dataSharingService.apiKey =
  ...
  public navigateToPayment() {
    if (this.locationId === 1) {
      if (environment.signUpForAuotoPay === 1) {
        this.router.navigate([`pay-rent/quitman-mini/rent-sub/login`]);
      } else {
        this.router.navigate(["pay-rent"]);
      }
    } else if (this.locationId === 2) {
      if (environment.signUpForAuotoPay === 1) {
        this.router.navigate([`pay-rent/heber-springs/rent-sub/login`]);
      } else {
        this.router.navigate(["pay-rent"]);
      }
  ...
  public navigateToContact() {
    if (this.router.url.includes("quitman-mini")) {
      this.router.navigate(["/contact-quitman-mini"]);
    } else if (this.router.url.includes("heber-springs")) {
      this.router.navigate(["/contact-heber-springs"]);

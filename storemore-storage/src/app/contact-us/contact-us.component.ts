...
public fetchTwitter() {
  ...
  public fetchContactDetailsLocation1() {
    this.heading = `Storemore Self Storage - Tuckahoe Road Location`;
    this.locationId = '1'
  ...
  public fetchContactDetailsLocation2() {
    this.locationId = '2'
    this.heading = `6588 Pratt Road, Sodus`;
    this.contactDetails = contactsLocation2;
    this.hoursDetails = hoursLocation2;
  }

  public fetchContactDetailsLocation3() {
    this.heading = `205 Rotterdam Road, Sodus`;
    this.locationId = '3'
  ...
  public fetchContactDetailsLocation4() {
    this.heading = `5587 Route 14, Alton`;
    this.locationId = '4'
  ...
  public fetchContactDetailsLocation5() {
    this.heading = `3913 Route 14, Lyons`;
    this.locationId = '5'
  ...
  public fetchContactDetailsLocation6() {
    this.heading = `5802 Limekiln Road, Wolcott`;
    this.locationId = '6'
    this.contactDetails = contactsLocation5;
    this.hoursDetails = hoursLocation5;
  }

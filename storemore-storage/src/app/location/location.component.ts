...
import { contactsLocation1, hoursLocation1, hoursLocation1AcessHours,
          ...
          contactsLocation4, hoursLocation4, contactsLocation5, contactsLocation6, hoursLocation5, hoursLocation6
          } from '../data/contact';
import { heading1, heading2, tabs, heading3, heading4, heading5, heading6  } from '../data/location';
...
this.titleService.setTitle(`${this.location3PageTitle}`);
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/Tuckahoe-Road/reserve-unit`],
          );
  } else if ( this.locationId === 2 ) {
    this.router.navigate([`${environment.locationName}/pratt-road/reserve-unit`],
          );
  }  else if ( this.locationId === 3 ) {
    this.router.navigate([`${environment.locationName}/rotterdam-road/reserve-unit`],
    );
  } else if ( this.locationId === 4 ) {
    this.router.navigate([`${environment.locationName}/alton/reserve-unit`],
    );
  } else if ( this.locationId === 4 ) {
    this.router.navigate([`${environment.locationName}/lyons/reserve-unit`],
    );
  } else if ( this.locationId === 4 ) {
    this.router.navigate([`${environment.locationName}/Wolcott/reserve-unit`],
    );
  }
 }

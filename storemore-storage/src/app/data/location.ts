...
export const heading1 = `6519 Tuckahoe Rd, Williamson`;

export const heading2 = `6588 Pratt Road, Sodus`;

export const heading3 = `205 Rotterdam Road, Sodus`;

export const heading4 = `5587 Route 14, Alton`;

export const heading5 = `3913 Route 14, Lyons`;

export const heading6 = `5802 Limekiln Road, Wolcott`;

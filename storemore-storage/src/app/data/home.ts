...
export const serviceOffered = [
    {
        p: `Are you a local cottage owner or seasonal camper looking for a place to store your extra stuff in the off season? Maybe you're a local resident or business just searching for a little extra elbow room.`,
    },
    {
        p: `Storemore Self Storage was founded in 1986 and is a locally owned and operated self storage business. We take pride in building relationships with our friends and neighbors through quality service and always maintaining competitive prices. We have 7 convenient locations and offer clean, well-maintained units, 24-hour access, and online payment options.`,
    },
    {
        p: `You'll love our hometown service - it's what sets us apart from the competition! Have a question about your account, or would like to rent additional units? We're here to help you with all of your self storage needs, so don't hesitate to give us a call.`,
    },
    {
        p: `Contact us today to reserve your storage unit!`,
    },
];

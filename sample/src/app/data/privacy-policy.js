...
var indexEmail = contact_1.contact.findIndex(function (x) { return x.label === 'Email:'; });
var email = contact_1.contact[indexEmail].data;
var redirectEmail = contact_1.contact[indexEmail].redirect;
var indexPhone = contact_1.contact.findIndex(function (x) { return x.label === 'Phone:'; });
var phone = contact_1.contact[indexPhone].data;
var redirectPhone = contact_1.contact[indexPhone].redirect;
exports.privacyPolicy = [
    {
        content: "This privacy notice discloses the privacy practices for \"" + environment_1.environment.websiteUrl + "\".\n      This privacy notice applies solely to information collected by this website. It will notify you of the following:",
        list: [
            {

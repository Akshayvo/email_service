...
export const aboutUsAlt = `two rows of indoor self storage units on either side of a clean aisle`;

export const aboutUsHeading = `Affordable Climate Controlled Self Storage Units in Herkimer, NY`;
...
export const gettingStarted = `Start de-cluttering your home, or reclaiming some elbow room at the office, today! Call our friendly management team, or click below to begin your reservation!`;

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Herkimer_Storage/herkimer-storage-outlet-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Herkimer_Storage/herkimer-storage-outlet-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Herkimer_Storage/herkimer-storage-outlet-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/dPXTSwqRSKHycdUt9",
     description: `Herkimer Storage Outlet serves Herkimer, Mohawk, Frankfort, and the surrounding communities
     with affordable climate controlled self storage units. We are a locally owned and operated business, and
     we pride ourselves on making our customers’ self storage projects fast and easy with our friendly
     customer service and modern amenities.`,
     streetAddress: "298 Harter St",
     state: "New York",

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Lois_Star/lois-stor-all-units.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Lois_Star/lois-stor-all-units.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Lois_Star/lois-stor-all-units.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/nQzYnyGSYzfJRYf88",
     description: "Affordable Storage Units in Burlington ... Lois Stor-All has been locally owned and operated since 1985.",
     streetAddress: "32114 Droster Ave",
     state: "Wisconsin",
     ...
     bestRating: "5",
     reviewCount: "24",
     latitude: 42.6962888178591,
     longitude: -88.26514486136585,
     openingHours: [],
     priceRange: ''
};

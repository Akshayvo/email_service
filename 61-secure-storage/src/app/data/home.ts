...
export const aboutUs = [
  {
    p: `Store QC has been making renovations, moves, and de-cluttering projects
  ...
  {
    p: `The conveniences at Store QC go beyond those physical amenities. We also offer online
        ...
        your unit with us today, and regain some of that elbow room with Store QC!`,
  },
];

export const gettingStarted = `Start that de-cluttering or renovation project you've been putting off, or
make your move easier with some extra space while you unpack. Get started with Store QC simply by

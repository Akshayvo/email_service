...
import { contactPageLocation1Script, ogContactPageLocation1, ogContactPageLocation2, ogContactPageLocation3,ogContactPageLocation4,
   twitterContactPageLocation1, twitterContactPageLocation2, twitterContactPageLocation3, twitterContactPageLocation4 } from '../data/script';
...
export class ContactUsComponent implements OnInit {
  ...
  public fetchOg() {
    ...
    } else if (this.router.url.includes('agricola')) {

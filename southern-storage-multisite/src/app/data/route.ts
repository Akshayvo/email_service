...
export const apiRoutes = [
  ...
  { path: 'contact-rocky-creek', component: ContactUsComponent},
  { path: 'contact-agricola', component: ContactUsComponent},
  { path: 'contact-barton', component: ContactUsComponent},
  { path: 'contact-wade', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-rocky-creek', component: PayRentFloridaComponent },
  { path: 'pay-rent-agricola', component: PayRentChesterComponent},
  { path: 'pay-rent-barton', component: PayRentMontgomeryComponent},
  { path: 'pay-rent-wade', component: PayRentMiddletownComponent},

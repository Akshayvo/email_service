...
export class UaParserService {
  ...
  determineBaseUrl() {
    ...
    if (this.typeOfImages === 'WEBP') {
      this.baseUrl = `https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Southern_Self_Storage/webp`;
    } else {
      this.baseUrl = 'https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Southern_Self_Storage/jpg';
    }
  }
}

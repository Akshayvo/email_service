...
import { contactsLocation1, hoursLocation1, hoursLocation1AcessHours,
          contactsLocation2, hoursLocation2, hoursLocation3, contactsLocation3,contactsLocation4, hoursLocation4,socialLinks,
          } from '../data/contact';
import { heading1, heading2, tabs,tabsBarton,tabsWade ,heading3,heading4  } from '../data/location';
...
id = 3;
  ...
  constructor(
    ...
    this.titleService.setTitle(`${this.location1PageTitle}`);
            this.locationName = `Southern Storage - Rocky Creek`;
    ...
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `Southern Storage - Agricola`;
    ...
    this.titleService.setTitle(`${this.location3PageTitle}`);
        this.locationName = `Southern Storage - Barton `;
    ...
    this.locationName = `Southern Storage - wade`;
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/rocky-creek/reserve-unit`],
          );
  } else if ( this.locationId === 2 ) {
    this.router.navigate([`${environment.locationName}/agricola/reserve-unit`],
          );
  }  else if ( this.locationId === 3 ) {
    this.router.navigate([`${environment.locationName}/barton/reserve-unit`],
         );
  }  else if ( this.locationId === 4 ) {
    this.router.navigate([`${environment.locationName}/wade/reserve-unit`],
          );
  }
 }

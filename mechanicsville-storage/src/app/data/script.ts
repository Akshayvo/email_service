...
export const script = {// Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Mechanicsville_Self_Storage/jpg/stock-self-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Mechanicsville_Self_Storage/jpg/stock-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Mechanicsville_Self_Storage/jpg/stock-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/RTWESYcjDh4959LW7",
     description: "Self Storage of Mechanicsville is the perfect storage solution for you! Our units are clean and well-maintained, and we offer a variety of sizes to choose from. Plus, our convenient location has around-the-clock access, so you'll always be able to get into your unit.",
     streetAddress: "1 Industrial Park Dr",
     state: "New York",

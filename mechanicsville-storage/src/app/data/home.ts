...
export const aboutUsHeading = `Affordable Self Storage Units in Mechanicsville`;
...
export const aboutUs = [
    ...
    {
        p: `Self Storage of Mechanicsville is the perfect place for you! Our units are clean and well-maintained, and we offer a variety of sizes to choose from. Plus, our convenient location offers around-the-clock access, so your unit will never be out of reach when you need it.`,
    },
    {
        p: `We know that finding the right self storage solution can be difficult, so we’re here to help make it easy for you. Give us a call today to learn more about our services and availability. We look forward to helping you during your next storage project`,
    },
...
export const jumbotron = [
    {
        h2: `Affordable Self Storage Units in Mechanicsville`,
        blurb: `Self Storage of Mechanicsville serves Mechanicsville and the surrounding communities in with clean, well-maintained storage units! Our facility has a wide variety of unit sizes that are ideal solutions to anyone looking for a little extra elbow-room around the home, office, or worksite!`,
    }
];

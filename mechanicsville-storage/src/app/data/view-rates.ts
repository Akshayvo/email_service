...
export const dataViewRates = [
    {
      p: `Looking for a self storage solution in Mechanicsville?`,
    },
    {
      p: `Self Storage of Mechanicsville is the perfect place to store your belongings. Our facility is well-maintained and our rates are affordable. Plus, we offer convenient hours and a conveniently located facility.`
    },
    {
      p: `We are committed to providing you with high-quality service and a storage experience that is easy and convenient.
      `
    },
    {
      p: `Give us a call today or visit our website to learn more about our services!`
    }
];

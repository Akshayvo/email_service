...
export class HomeComponent implements OnInit {
  ...
  constructor(
    ...
    this.meta.addTag({
      name: 'description',
      content: `Whether you're looking for regular self storage, climate-controlled units, or outdoor parking spaces,
      All Space Self Storage has you covered! Call Today!`
    });

...
export const dataViewRates = [
  {
    p: `Our facility is here to make your self storage experience an affordable and convenient
    one. After reviewing our affordable climate-controlled unit availability and rates, fill out
    our reservation form and we'll reach right back out to get you started!`,
  },
  {
    p: `Don't forget to check out our storage tips page, and learn how to make your stay
    at Storage Locker Ltd that much easier!`
  },
];

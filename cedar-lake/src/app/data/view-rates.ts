...
export const dataViewRates = [
    {
      p: `Take your time to review our rates and find a spot that suits your needs. You can complete your reservation or rental application in minutes through our online portal, and one of our friendly managers will reach out to assist you in completing the rental process. `,
    },
    {
      p: `Soon you’ll have that space in your yard or garage available once more with easy access to your vehicle from 7:00AM to 7:00PM 7 days a week. Still have questions? Give us a call today!`
    }

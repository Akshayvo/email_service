...
import { RentalProcedureComponent } from "../rental-procedure/rental-procedure.component";
...
export const apiRoutes = [
  ...
  { path: "rental-procedure", component: RentalProcedureComponent },
...
export const iFrameRoutes = [
  ...
  {
    path: `${environment.locationName}/reserve-unit`,
    component: ReserveUnitIframePageComponent,
  },
  { path: "contact-us", component: ContactComponent },
  { path: "unit-sizer", component: UnitSizerComponent },
  { path: "privacy-policy", component: PrivacyPolicyComponent },

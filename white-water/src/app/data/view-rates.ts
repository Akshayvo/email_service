...
export const dataViewRates = [
    {
      p: `CLIMATE CONTROLLED UNITS: In the winter we maintain the building at 55 degrees and in the summer the A/C 
      is set at 78 degrees.`
    },
    {
      p: `2D behind the unit size means there are two doors for the unit, one on each end of the unit.`
    },
   {
     p: `Please call the office or stop in to make sure we have a unit available for you or if someone 
     is in the process of moving out. Bring your driver's license. We will not rent to someone that we 
     don't have required identification from to aid in the security of all our tenants, `
   },
   {
     p: `If you're not sure what size unit you need and want to take a look at a couple of different 
     size units to make sure you get the right-sized unit ask the manager for the keys and go out and 
     take a look. After you decide come back to the office and we'll get you signed up. We also have 
     the Unit Sizer tab that will give you some guidelines. `
   },
   {
   ...
   {
     p: `Time to move out? We ask that you give us a 10-day notice prior to moving out. You must 
     fill out a move-out form to verify when you are moving out and to assure us that we send your 
     deposit to the correct address. In addition, you must return the two keys and sweep the unit 
     clean when you move out to get your full deposit back. It can take up to two weeks for us to 

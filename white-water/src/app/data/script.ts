...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/White_Water_Storage/jpg/whitewater-self-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/White_Water_Storage/jpg/whitewater-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/White_Water_Storage/jpg/whitewater-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/cNvm1218hFLkVsXk9",
     description: "Whitewater Self Storage has been Whitewater Wisconsin's premier self storage facility since 1983. Our storage facility provides both regular and climate controlled self storage units in a wide variety of sizes. We were built from the ground up to maximize convenience and a sense of security for our valued customers. Start your next storage project today by taking a moment to review our unit rates, then reserving your unit online or calling our friendly self storage staff!",

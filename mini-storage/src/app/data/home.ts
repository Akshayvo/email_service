...
export const featuresList = [
    ...
    {
        td1: 'Pin-Pad Activated Security Doors',
...
export const feature = [
    ...
    {
        // tslint:disable-next-line:max-line-length
        path: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/390_Self_Storage/location.svg',
...
export const aboutUs = [
    {
        mainHeading: `Affordable Storage Units in Wingate`,
        mainParagraph: `Opening in July 2022!`,
        subHeading1: {
...
export const jumbotron = [
    {
        h2: `Affordable Storage Units in Wingate`,
        blurb: `Opening in July 2022!`,
    }
];
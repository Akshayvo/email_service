...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
     ...
     description: "Richfield Springs Self Storage is the #1 choice for self storage in Richfield Springs. We are locally owned and operated, so you can trust our knowledgeable and experienced storage management team. Whether you're looking to store a few boxes or an entire houseful of furniture, we have everything you need for your storage needs at prices that won't break the bank!",
     streetAddress: "15 Tamarack Rd",
     state: "New York",
     addressLocality: "Richfield Springs",
     addressRegion: "NY",
     postalCode: "13439",
     addressCountry: "US",

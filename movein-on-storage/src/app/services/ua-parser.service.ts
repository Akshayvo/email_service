...
export class UaParserService {
  ...
  determineBaseUrl() {
    ...
    if (this.typeOfImages === 'WEBP') {
      this.baseUrl = `https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Movein_On_Storage/webp`;
    } else {
      this.baseUrl = 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Movein_On_Storage/jpg';
    }
  }
}

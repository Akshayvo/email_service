export const featuresList = [
    ...
    {
        td1: 'All Climate-Controlled Units',
    }
];

export const aboutUsHeading = `Climate-Controlled Storage in Hendersonville`;
...
export const gettingStarted = `Start that renovation, or home project you've been putting off today, and store your belongings at Storage Locker Ltd`;

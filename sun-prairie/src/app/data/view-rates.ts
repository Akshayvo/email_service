...
export const viewRates = [
  {
    p: `Sun Prairie Self Storage provides Sun Prairie, Cottage Grove, Windsor, and the
            surrounding communities with high quality self storage and parking for boats,
            recreational vehicles, and trailers. All of our clean, well-maintained self
            storage units were built in 2018, and are secured behind a pin-code activated
            gate. We keep the facility well-lit, and covered by over 20 security cameras
            placed throughout the facility.`,
  },
  {
    p: `Take a moment to check out our pricing and availability, then use our handy
            self storage tenant portal website or 24-kiosk at the facility to move into
            a brand new self storage unit or parking space today! `,
  },
];

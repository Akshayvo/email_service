export const galleryHome = [
  ...
  //   // tslint:disable-next-line:max-line-length
  //   thumb: `sun-prairie-self-storage-front-office-exterior-thumb`,
  //   alt: `single story front office of a self storage facility in a brick building with large glass windows`
  // },
  // {
  //   // tslint:disable-next-line: max-line-length
  //   url: `sun-prairie-self-storage-front-office-desk`,
  //   // tslint:disable-next-line:max-line-length
  //   thumb: `sun-prairie-self-storage-front-office-desk-thumb`,
  //   alt: `inside of a self storage front office with a front counter, a chair for customers, and large monitors
  //   displaying security cameras around the facility`
  // },
  {
    // tslint:disable-next-line: max-line-length
    url: `sun-prairie-self-storage-truck-parking`,
    // tslint:disable-next-line:max-line-length

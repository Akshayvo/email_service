...
export const featuresHead =
  "The Only Self Storage in Greene County With All of The Following";
...
export const feature = [
  {
    path:
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Syrasoft_Poweredby/icons/24-hours.svg",
    label: "24 Hour Facility Access",
    alt: "Icon art displaying clock hands and the number 24",
  },
  {
    path:
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Syrasoft_Poweredby/icons/hand.svg",
    label: "Affordable Self Storage Rates",
    alt: "Icon of a hand holding money",
  },
  {
    path:
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Syrasoft_Poweredby/icons/light-bulb.svg",
    label: "Well-Lit Facility",
    alt: "Icon of an illuminated light",
  },
  {
    path:
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Syrasoft_Poweredby/icons/team.svg",
    label: "Family Owned and Operated",
    alt: "Icon of people standing together",
  },
  {
    path:
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Syrasoft_Poweredby/icons/thermometer.svg",
    label: "Climate Controlled",
    alt: "Icon of thermometer indicating climate-controlled units",
  },
  {
    path:
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Syrasoft_Poweredby/icons/cctv.svg",
...
export const aboutUs = [
  {
    p: `Since 2018, Sun Prairie Self Storage has served Sun Prairie, Madison, Marshall,
            and the surrounding communities with 24-hour access to their belongings, equipment,
            and recreational vehicles, boats, or trailers. Come and go as you please with our
  ...
  },
  {
    p: `We are a locally owned and operated self storage facility with decades of experience providing
            exceptional service to our valued customers. Sun Prairie Self Storage has competitive pricing,
            and charges no security deposit! We accept all major credit cards, and you can sign up for
            automatic payments for added convenience!  `,
  },
];
...
export const gettingStarted = `Are you ready to start reclaiming that space around your home, worksite, or yard? 
                               Call or rent one of Sun Prairie Self Storage's affordable self storage units, or 
                               vehicle parking spaces, today!`;

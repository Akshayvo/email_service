...
export const dataViewRates = [
    {
      p: `Graycliff Self Storage is a locally owned and operated self storage facility that provides high-quality, well-maintained self storage services in Marion, West Marion, Providence, and the surrounding areas! Our storage units are perfect for your residential or commercial storage needs. From moves to renovations and off-site equipment storage, Graycliff Self Storage has you covered. Take a moment to review our availability, then rent your unit online in minutes with our easy online rental application.`,
    },
];

...
export const apiRoutes = [
    ...
    { path: `${environment.locationName}/okc-storage`,
    ...
    { path: 'review/okc-storage', component: HomeComponent,
    resolve: {
  ...
  {
    path: 'pay-rent/okc-storage', component: PayRentComponent,
    children: childroute
  },
  {
  ...
  { path: 'contact-okc-storage', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-okc-storage', component: PayRentFloridaComponent },

...
export const jumbotron = [
    {
        h1: `Climate-Controlled Storage Units in Huntsville`,
        blurb: `Advantage Climate Control Self Storage offers over 300 climate controlled storage units that
                range from closet-sized through an extra large garage, perfect for the belongings that need a
                little extra protection from the elements. Our state-of-the-art facility has a full retail store
                with packing supplies, keypad-secured doors, and we even rent U-Haul trucks to make your self
                storage or moving experience a breeze!`,
    }
];

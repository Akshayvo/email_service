...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  public fetchContactDetail() {
    ...
    if (this.router.url.includes('south-wenatchee')) {
      this.id = 1;
      this.name = 'South Wenatchee Self Storage - south-wenatchee';
      ...
      this.id = 2;
      this.name = 'South Wenatchee Self Storage - leos-self-storage';
      ...
      this.id = 3;
      this.name = 'South Wenatchee Self Storage - Location-3';

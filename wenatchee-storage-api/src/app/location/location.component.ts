...
id = 3;
  ...
  constructor(
    ...
    this.titleService.setTitle(`${this.location1PageTitle}`);
            this.locationName = `South Wenatchee Self Storage - south-wenatchee`;
    ...
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `South Wenatchee Self Storage - leos-self-storage`;
    ...
    this.titleService.setTitle(`${this.location3PageTitle}`);
        this.locationName = `South Wenatchee Self Storage - Location-3 Location`;

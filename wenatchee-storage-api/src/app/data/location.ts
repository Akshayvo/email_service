...
export const heading4 = `South Wenatchee Self Storage - Belforest`;

export const heading5 = `South Wenatchee Self Storage - Fairhope`;

export const heading6 = `South Wenatchee Self Storage - Robertsdale`;

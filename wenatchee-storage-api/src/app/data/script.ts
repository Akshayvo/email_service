...
export const nameLocation1 = `South Wenatchee Self Storage - south-wenatchee`;
export const nameLocation2 = `South Wenatchee Self Storage - leos-self-storage`;
export const nameLocation3 = `South Wenatchee Self Storage - Location-3`;
...
export const description1 = `brick South Wenatchee Self Storage front office with a green lawn

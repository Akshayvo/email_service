...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Dean_Storage/jpg/stock-self-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Dean_Storage/jpg/stock-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Dean_Storage/jpg/stock-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/raAzkMP1cy1dyHcv6",
     description: "Dean Storage offers a number of conveniences and security considerations that make us Lyon's go-to self storage solution. Our facility is clean and well-maintained, making our variety of unit sizes the perfect answer to your storage needs.",
     streetAddress: "17 Forgham St",
     state: "New York",

export const homePageTitle = `Affordable Self Storage Units in Lyons, N.Y.`;
export const homePageContent = `Dean Storage serves Lyons and the surrounding communities with a variety of well-maintained and affordable self storage units`;

export const viewRatesPageTitle = `View Rates  | Dean Storage`;
...
export const payRentPageTitle = `Pay Rent  | Dean Storage`;
...
export const storageTipsTitle = `Storage Tips  | Dean Storage`;
export const storageTipsContent = `Follow these easy self storage tips to make your stay with Dean Storage a breeze! Have questions? Call today!`;

export const unitSizerPageTitle = ``;
export const unitSizerPageContent = ``;

export const contactPageTitle = `Contact Us  | Dean Storage`;

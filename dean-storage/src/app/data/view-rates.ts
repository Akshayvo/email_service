...
export const dataViewRates = [
    {
      p: `Dean Storage is the perfect solution for your self storage needs. We offer a number of clean, well-lit units that are available to rent on a month-to-month basis. Whether you’re moving into town or just need some extra room in your home, we have the right unit for you!`,
    },
    {
      p: `Take a moment to review our current unit rates and availability, then reserve your storage unit through our tenant portal. A member of our team will reach out shortly to confirm your details. We can't wait to meet you!`
    },

...
export const aboutUs = [
    {
        p: `White Lake Storage is Whitehall’s newest self storage facility! We are conveniently located on Whitehall Rd
        between Silver Creek Rd and Lorenson Rd just east of Whitehall. We are proud to be a locally owned and operated
        business serving Whitehall, Holton, Montague, and the surrounding communities. Our facility offers a number of

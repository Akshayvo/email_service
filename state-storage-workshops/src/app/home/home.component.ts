...
export class HomeComponent implements OnInit {
  ...
  constructor(@Inject(WINDOW) private window: Window,
    ...
    this.meta.addTag({
      name: 'description',
      content: `State Storage Workshops offers affordable rates for self storage units, and up to 240v electrified workshops as large as 1,200 feet in North Largo!`
    });
    this.titleService.setTitle('Self Storage & Workshops | State Storage Workshops');
  }

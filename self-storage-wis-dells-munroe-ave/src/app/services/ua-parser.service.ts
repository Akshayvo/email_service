...
export class UaParserService {
  ...
  determineBaseUrl() {
    ...
    if (this.typeOfImages === 'WEBP') {
      this.baseUrl = `https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Self_Storage_Wisconsin_Dells_Munroe_Ave/webp`;
    } else {
      this.baseUrl = 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Self_Storage_Wisconsin_Dells_Munroe_Ave/jpg';
    }
  }
}

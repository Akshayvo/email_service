...
export class ContactUsComponent implements OnInit {
  ...
  public fetchOg() {
    if (this.router.url.includes('cedar')) {
      this.og = ogContactPageLocation1;
    } else if (this.router.url.includes('e-town')) {
...
public fetchTwitter() {
  ...
  public fetchContactDetailsLocation1() {
    this.heading = `Cedar Springs Self Storage - Cedar`;
    this.locationId = '1'
  ...
  public fetchContactDetailsLocation2() {
    this.locationId = '2'
    this.heading = `Cedar Springs Self Storage - E-Town`;

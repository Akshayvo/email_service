...
import { contactsLocation1, hoursLocation1, hoursLocation1AcessHours,
          contactsLocation2, hoursLocation2, hoursLocation2AcessHours
          } from '../data/contact';
import { heading1, heading2, tabs, tabs1, tabs2,  tabs3  } from '../data/location';
...
export class LocationComponent implements OnInit {
  ...
  constructor(
    ...
    this.titleService.setTitle(`${this.location1PageTitle}`);
            this.locationName = `Cedar Springs Self Storage - Cedar`;
    ...
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `Cedar Springs Self Storage - E-Town`;
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/cedar/reserve-unit`],
          );
  } else if ( this.locationId === 2 ) {
    this.router.navigate([`${environment.locationName}/e-town/reserve-unit`],
          );
  }  
 }

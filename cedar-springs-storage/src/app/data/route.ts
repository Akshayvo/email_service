...
export const apiRoutes = [
    ...
    { path: 'review/cedar', component: HomeComponent,
    resolve: {
  ...
  { path: 'review/e-town', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  {
    path: 'pay-rent/cedar', component: PayRentComponent,
    children: childroute
  },
  {
    path: 'pay-rent/e-town', component: PayRentComponent,
    children: childroute
  },
  {
  ...
  { path: 'contact-cedar', component: ContactUsComponent},
  { path: 'contact-e-town', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-cedar', component: PayRentFloridaComponent },
  { path: 'pay-rent-e-town', component: PayRentChesterComponent},

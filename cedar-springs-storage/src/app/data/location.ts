...
export const headingReservePageLocation1 = `Ready to Reserve a Self Storage Unit in Cedar`;

export const headingReservePageLocation2 = `Ready to Reserve a Self Storage Unit in E-Town`;


export const heading1 = `Cedar Springs Self Storage - Cedar`;

export const heading2 = `Cedar Springs Self Storage - E-Town`;

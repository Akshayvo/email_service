...
export const dataViewRates = [
    {
      p: `Added Space Self Storage has been serving Turlock and the surrounding communities with clean, well-lit, and affordable storage units and recreational vehicle, or boat parking spaces for over 30 years. `,
    },
    {
      p: `As a family owned and operated business, we understand the value of customer service. That's why we go the extra mile every day to make your stay with us a convenient one.`
    },
    {
      p: `Have questions about our storage units or parking spaces? Give our office a call today!
      `
    }
];

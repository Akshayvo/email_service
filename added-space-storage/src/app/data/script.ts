...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Added_Space_Self_Storage/jpg/added-space-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Added_Space_Self_Storage/jpg/added-space-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Added_Space_Self_Storage/jpg/added-space-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/fWCT13M4Sc9zgoQaA",
     description: "Added Space Self Storage is Turlock's most trusted facility. We have a number of self storage unit sizes and vehicle parking spaces to meet any of your self storage or parking needs! Our modern facility is well-lit, secured by pin-code activated gate, and we offer the kind of friendly service only a locally owned & operated business can provide!",
     streetAddress: "2555 W Main St",
     state: "California",
     ...
     paymentAccepted:  "Check, Cash, Credit Card, Debit Card",
     currenciesAccepted: "USD",
     ratingValue: "3.9",
     bestRating: "5",
     reviewCount: "38",
     latitude: 37.4944406,
     longitude: -120.8772885,
     openingHours: ['9:00AM to 5:00PM','10:00AM to 4:00PM'],
     priceRange: ''
};

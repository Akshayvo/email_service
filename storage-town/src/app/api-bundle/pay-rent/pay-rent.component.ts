...
export class PayRentComponent implements OnInit {
  ...
  constructor(
    ...
    if (
      this.router.url.includes("chester-brookside-ave") ||
      this.router.url.includes("chester-andrews-lane")
    ) {
  ...
  ngOnInit() {
    ...
    this.dataSharingService.paymentNavigation =
      this.activatedRoute.snapshot.url[1].path;
    localStorage.setItem(
      "paymentNavigationUrl",
      this.dataSharingService.paymentNavigation
    );
  }

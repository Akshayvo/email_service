  ...
  constructor(
    ...
    if (this.router.url.includes("/location/chester-andrews-lane")) {
      ...
      this.titleService.setTitle(
        "Storage Units in Chester, NY | StorageTown Rental Spaces"
      );
      ...
      this.titleService.setTitle(
        "Self Storage Units in brookside | StorageTown Rental Spaces"
      );
      ...
      this.titleService.setTitle(
        "Storage Units in Montgomery, NY | StorageTown Rental Spaces"
      );
      ...
      this.titleService.setTitle(
        "Self Storage Units in Middletown | StorageTown Rental Spaces"
      );

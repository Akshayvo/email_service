...
import { contactPageLocation2Script } from '../data/script';
import { CanonicalService } from '../services/canonical.service';

@Component({
  selector: 'app-contact-florida',
  templateUrl: './contact-florida.component.html',
  styleUrls: ['./contact-florida.component.scss']
})
export class ContactFloridaComponent implements OnInit {

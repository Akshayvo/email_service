...
export const dataViewRates = [
    {
      p: `Sodus Self Storage Plus is Sodus’ newest self storage facility. We cater to the storage needs of year-round homeowners, and the seasonal needs of cottage owners, boaters, and local businesses serving Sodus, Sodus Point, North Rose, and the surrounding communities.`,
    },
    {
      p: `Our facility offers a variety of regular and climate controlled storage units along with parking for recreational vehicles, boats, and trailers. Take a moment to review our current inventory, then rent your unit online or give us a call! We look forward to meeting you!`
    },
    // {
    //   p: `
    //   `
...
export const viewRatesAltText = `a row of self storage units with one metal roll up door opened to reveal personal belongings`;

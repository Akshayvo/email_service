...
export class ReserveUnitFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    console.log(this.dataSharingService.getReservationData().MonthlyRate);
  ...
  getData() {
    this.getDataSubscribe$ = this.fetchDataService
      ...
      .subscribe((unitTypesResponse) => {
        ...
        const defaultMonthlyValue = 0; //this.filterLstUnitTypes[0].MonthlyRate
        this.description = ""; //this.filterLstUnitTypes[0].Description;
        this.reservationFeeTax = 0; //this.filterLstUnitTypes[0].ReservationFeeTax;
        this.reservationFee = 0; //this.filterLstUnitTypes[0].ReservationFee;
        this.monthlyRate =
        ...
        this.unitTypeID = 0; //this.filterLstUnitTypes[0].UnitTypeID;
        if (this.navigateToMoveIn) {
          // tslint:disable-next-line:max-line-length
          this.getMoveInCharges(
            this.unitTypeId,

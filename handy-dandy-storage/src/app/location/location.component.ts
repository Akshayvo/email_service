...
import { contactsLocation1, hoursLocation1, hoursLocation1AcessHours,hoursLocation2AcessHours,
...
export class LocationComponent implements OnInit {
  ...
  constructor(
    ...
    this.titleService.setTitle(`${this.location1PageTitle}`);
            this.locationName = `Handy Dandy Storage`;
    ...
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `North Road Storage`;
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/handy-dandy/reserve-unit`],
          );
  } else if ( this.locationId === 2 ) {
    this.router.navigate([`${environment.locationName}/north-road/reserve-unit`],
          );
  } 

...
export const apiRoutes = [
    ...
    { path: 'review/handy-dandy', component: HomeComponent,
    resolve: {
  ...
  { path: 'review/north-road', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  {
    path: 'pay-rent/handy-dandy', component: PayRentComponent,
    children: childroute
  },
  {
    path: 'pay-rent/north-road', component: PayRentComponent,
    children: childroute
  },
  {
  ...
  { path: 'contact-handy-dandy', component: ContactUsComponent},
  { path: 'contact-north-road', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-handy-dandy', component: PayRentFloridaComponent },
  { path: 'pay-rent-north-road', component: PayRentChesterComponent},

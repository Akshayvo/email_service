...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
     ...
     description: "Affordable Boat, RV & Camper Storage in Clifton Park",
     streetAddress: "1751 U.S. 9 Clifton Park",
     state: "New York",
     ...
     bestRating: "5",
     reviewCount: "5",
     latitude: 42.87169760158919,
     longitude: -73.7723132195978,
     openingHours: [],
     priceRange: '280 - 320'
};

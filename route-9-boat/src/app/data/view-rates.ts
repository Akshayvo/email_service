...
export const dataViewRates = [
    {
      p: `Route 9Boat N Rv Storage is Clifton Park's newest vehicle storage facility! Make room in your yard by storing your boat, recreational vehicle or trailer in one of our high quality vehicle storage units.`,
    },
    {
    ...
    {
      p: `Do you have questions about Route 9Boat N Rv Storage services? Reserve online, call, or use our contact form today!`
    }
];

...
export const dataViewRates = [
    {
      p: `Our locally owned and operated self storage and vehicle parking facility serves Arcanum, 
      West Manchester, New Paris, and the surrounding communities in Darke county with affordable 
      storage and vehicle parking. `,
    },
    {
      p: `Take a moment to review our pricing and availability, then rent your unit online in 
      minutes with our easy rental application. You’ll receive a digitally signable lease in your email, 
      and once it’s signed, your brand new storage unit will be available for you to occupy. After that, 
      you’ll have access to your account 24-7 through our easy online tenant portal.`
    },
    {
      p: `Still have questions? Give our friendly team a call today! We’ll be happy to help!`
    },
];

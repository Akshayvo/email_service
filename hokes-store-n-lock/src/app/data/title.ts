...
export const payRentPageTitle = `Pay Rent  | Hoke's Store-N-Lock - North`;
...
export const storageTipsTitle = `Storage Tips  | Hoke's Store-N-Lock - North`;
export const storageTipsContent = `Use our helpful self storage tips list to make your stay at Hoke's Store-N-Lock - North an easy and enjoyable one!`;

export const unitSizerPageTitle = `Unit Sizer  | Hoke's Store-N-Lock - North`;
export const unitSizerPageContent = `Are you not sure what size unit you require? Use this guide to help you figure out what fits inside the units offered at Hoke's Store-N-Lock - North!`;

export const contactPageTitle = `Contact Us  | Hoke's Store-N-Lock - North`;
...
export const privacyPolicyPageTitle = `Privacy Policy | Hoke's Store-N-Lock - North`;

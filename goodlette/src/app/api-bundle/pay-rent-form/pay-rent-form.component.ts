...
export class PayRentFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.blnAllowPartialPayments =
      objSIMSetting.objPaymentSetting.blnAllowPartialPayments;
          ...
          if (tenantData) {
            ...
            for (const i in this.UnpaidAR) {
              ...
              if (this.UnpaidAR[i].AmountOwed < 0) {
                this.UnpaidAR[i].amountOwed = Math.abs(
  ...
  public navigateToConfirmation() {
    this.router.navigate([
      `${environment.locationName}/view-rates/confirmation`,
    ]);
  }
          ...
          if (paymentDataResponse.intErrorCode === 1) {
            ...
            if (this.navigateToReserve) {
              ...
              if (this.navigateToMoveIn) {
                ...
                if (!!this.paymentTab) {
                  this.router.navigate([
                    `pay-rent/${this.paymentTab}/thank-you`,
                  ]);
                } else {

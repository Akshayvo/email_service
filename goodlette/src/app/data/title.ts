export const homePageTitle = `Affordable Self Storage Units in Naples, FL`;
export const homePageContent = `Goodlette Self Storage serves Naples and the surrounding communities with a variety of well-maintained and affordable self storage units.`;

export const viewRatesPageTitle = `View Rates  | Goodlette Self Storage`;
...
export const reservePageTitle = `Reserve a Unit | Goodlette Self Storage`;
...
export const payRentPageTitle = `Pay Rent  | Goodlette Self Storage`;
...
export const storageTipsTitle = `Storage Tips  | Goodlette Self Storage`;
export const storageTipsContent = `Use our helpful self storage tips list to make your stay at Goodlette Self Storage an easy and enjoyable one!`;

export const unitSizerPageTitle = `Unit Sizer  | Goodlette Self Storage`;
export const unitSizerPageContent = `Are you not sure what size unit you require? Use this guide to help you figure out what fits inside the units offered at Goodlette Self Storage!`;

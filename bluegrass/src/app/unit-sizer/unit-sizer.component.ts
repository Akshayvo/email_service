  ...
  public isSomePage() {
    if (this.router.url.includes('/filitreau-lane')) {
      ...
      this.heading = 'Unit Sizer',
        ...
        size and what typically fits. TIP: remember to think 'cubic', do your items just need floor space or can
        they stack and fit together? *Actual contents vary depending of the size of your belongings.`;

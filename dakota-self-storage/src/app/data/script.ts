...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Dakota_self_storage/jpeg/stock-self-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Dakota_self_storage/jpeg/stock-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Dakota_self_storage/jpeg/stock-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/wN9YknkPJNithXao6",
     description: "Dakota Self Storage is Rapid City’s newest self storage facility. Our new facility is conveniently located on Valley Drive just north of SD-44, and was built from the ground up with convenience and security in mind. We offer a variety of self storage unit sizes at affordable prices that are ideal for any residential or commercial storage need. ",
     streetAddress: "1025 N Valley Dr",
     state: "South Dakota",

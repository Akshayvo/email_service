...
export const featuresHead = [
    {
        ...
        data: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Inez_Storage/location.svg',
        alt: 'Icon art displaying a location pin'
    },
    {
        label: 'Boat and Recreational Vehicle Storage',
        data: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Inez_Storage/garage.svg',
        alt: 'Icon art displaying boat and motorcycle'
    },
    {
        label: 'Climate Controlled Units Available',
        data: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Inez_Storage/thermometer.svg',
        alt: 'Icon of thermometer indicating climate controlled units'
    },
    {
        label: 'Fully-Fenced Facilities',
        data: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Inez_Storage/fence.svg',
...
export const serviceOffered = [
    ...
    {
        p: `- Mark and Jennifer James`,
    },
];

export const gettingStarted = `For God so loved the world that he gave his one and only Son, that whoever believes in him shall not perish but have eternal life.`;

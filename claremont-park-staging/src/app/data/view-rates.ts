...
export const dataViewRates = [
    {
      p: `Check out our self storage unit and parking space rates above, then make your reservation in just a 
      few minutes with our easy tenant portal. Once of our friendly managers will follow up shortly to confirm 
      your details and help you proceed with the rental process! Once you're a tenant at Claremont Park Self Storage, 
      you'll have access to your account through our online account management system 24-hours a day!`,
    },
];

export const viewRatesAltText = `a row of blue metal roll up self storage unit doors`;

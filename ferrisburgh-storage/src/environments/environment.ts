...
export const environment = {
  ...
  locationName: 'vermont/north-ferrisburgh', // state/city  **Remeber to update locationName in sitemap.xml as well
  ...
  facilityName: 'Ferrisburgh Self Storage',
  VERSION: require('../../package.json').version,
  baseUrl: `https://simapi.syrasoft.com/1/api/`,
  websiteUrl: 'https://www.ferrisburghselfstorage.com',

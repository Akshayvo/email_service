...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Ferrisburgh_Self_Storage/jpg/storage-units.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Ferrisburgh_Self_Storage/jpg/storage-units.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Ferrisburgh_Self_Storage/jpg/storage-units.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/orULNAsYDCvWF5h9A",
     description: "Ferrisburgh Self Storage offers convenient 24/7 access to your belongings, online payments and a variety of unit sizes for all of your self storage needs.",
     streetAddress: "7175 US-7",
     state: "Vermont",
     addressLocality: "North Ferrisburgh",
     addressRegion: "VT",
     postalCode: "05473",
     addressCountry: "US",
     ...
     latitude: 44.2617,
     longitude: -73.22837,
     openingHours: ["7 Days a Week:6:00AM to 9:00PM"],
     priceRange: '$50-$200'
};

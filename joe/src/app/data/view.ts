export const viewRate = [
    ...
    {
        p: `We have temperature controlled units for belongings, inventory and equipment that
        require extra protection from the elements. Our easy online reservation system and bill-pay
        service make every step of your storage experience a breeze!`,
    },
];

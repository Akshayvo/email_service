...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Storage_King_Inc/jpg/storage-king-inc-jumbotron.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Storage_King_Inc/jpg/storage-king-inc-jumbotron.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Storage_King_Inc/jpg/storage-king-inc-jumbotron.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/dm2nV96xkSLVJASc6",
     description: "We are Pinehurst's premier self storage facility serving our community with clean and affordable storage units.",
     streetAddress: "35335 TX-249 A",
     state: "Texas",
     ...
     latitude: 30.1511,
     longitude: -95.6942,
     openingHours: ["Mon-Fri:9:00AM-7:00PM","Sat:9:00AM-4:00PM"],
     priceRange: '$55-$275'
};

...
import { thFloral } from '../../data/view-rates';
import { Router } from '@angular/router';
import { DataSharingService } from '../services/data-sharing.service';


@Component({
  selector: 'app-view-rates-floral',
  templateUrl: './view-rates-floral.component.html',
  styleUrls: ['./view-rates-floral.component.scss']
})
export class ViewRatesFloralComponent implements OnInit {

...
export class ContactComponent implements OnInit {
  ...
  constructor(
    ...
    this.meta.addTag({
      name: 'description',
      content: `Do you have a question about our services, or would like information about your account? Use our contact form, and one of our managers will reach out shortly!`
    });
    this.titleService.setTitle('Contact Us | Affordable Secure Storage');

...
export class ReserveUnitFormComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    if ((this.router.url.includes('reserve'))) {
      ...
      // this.navigateToMoveIn = true; //added 
      ...
      // this.showMilitaryDetails = (environment.military === true) ? true : false; //added
      // this.dataSharingService.showMilitaryDetails = this.showMilitaryDetails;  //added

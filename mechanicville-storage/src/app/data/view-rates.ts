...
export const dataViewRates = [
    {
      p: `Looking for a self storage solution in Mechanicville?`,
    },
    {
      p: `Self Storage of Mechanicville is the perfect place to store your belongings. Our facility is well-maintained and our rates are affordable. Plus, we offer convenient hours and a conveniently located facility.`
    },
    {

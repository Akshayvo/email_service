...
export const script = {// Please fill this script according to facility's information
    imagesHomePage: [
     ...
     description: "Self Storage of Mechanicville is the perfect storage solution for you! Our units are clean and well-maintained, and we offer a variety of sizes to choose from. Plus, our convenient location has around-the-clock access, so you'll always be able to get into your unit.",
     streetAddress: "Industrial Park Dr",
     state: "New York",

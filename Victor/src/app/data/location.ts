...
export const heading1 = `About Victor Self Storage - Mall`;

export const heading2 = `About Victor Self Storage - Village`;

export const aboutUsImage1 = `https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Victor_Images/SlideShow/victor-self-storage-drive-up-access.jpg`;

export const aboutUsImage2 = `https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Victor_Images/SlideShow/victor-self-storage-drive-up-access.jpg`;

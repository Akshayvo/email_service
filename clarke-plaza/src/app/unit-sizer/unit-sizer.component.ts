...
export class UnitSizerComponent implements OnInit {
  ...
  public fetchDetailsLocation2() {
    this.h2tag = 'Unit Sizer';
    this.description = `Not sure what unit size your project requires? Check out our unit sizer below! If you still have questions, give our office a call, and one of our friendly managers will be happy to assist you.`;

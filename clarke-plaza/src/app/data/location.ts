...
export const headingReservePageLocation1 = `Ready to Reserve a Self Storage Unit in Clarke Plaza`;
...
export const heading2 = `Clarke Plaza Self Storage - Ossipee`;
...
export const unitSizerLocation2 = [
    ...
    },
    {
        ...
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/10x30.png',
        data: `This unit is approximately 400sq feet of space that can store the contents of a multi-bedroom home,
        including.`,
        amenities: [
            { content: 'Appliances', },
            { content: 'Car or Small Boat', },

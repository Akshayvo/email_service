...
export class ContactComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.fetchTableData();
    this.dataSharingService.currentRouteForContact.subscribe((updatedRoute) => {
      this.currentRouteForContact = updatedRoute;
      //console.log(this.currentRouteForContact);
    });
  }
  ...
  public fetchContactDetailsLocation1() {
    this.heading = `Clarke Plaza Self Storage - Clarke Plaza`;
  ...
  public onClick(url: any) {
    this.dataSharingService.setContact(url);
    // console.log(this.currentRouteForContact);
  }
}

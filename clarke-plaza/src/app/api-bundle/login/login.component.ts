...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  public fetchContactDetail() {
    ...
    if (this.router.url.includes('clarke-plaza')) {
      this.id = 1;
      this.name = 'Clarke Plaza Self Storage - Clarke Plaza';
      ...
      this.id = 2;
      this.name = 'Clarke Plaza Self Storage - Ossipee';
    ...
    //   this.id = 3;
    //   this.name = 'Clarke Plaza Self Storage - Barnwell';
    ...
    //   this.id = 4;
    //   this.name = 'Clarke Plaza Self Storage - Belforest';
    ...
    //   this.id = 5;
    //   this.name = 'Clarke Plaza Self Storage - Fairhope';
    ...
    //   this.id = 6;
    //   this.name = 'Clarke Plaza Self Storage - Robertsdale';

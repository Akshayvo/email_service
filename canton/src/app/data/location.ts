...
export const headingLocation2 = `Louisville Self Storage`;

export const headingLocation3 = `Lincoln Street Storage`;
...
export const unitSizerLocation2 = [
    {
        size: '5\' x 6\' Storage Unit',
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/5x5.png',
        data: `This unit is approximately 30 sq feet of space that can hold the contents of one small closet, such as:`,
        alt: '5\' x 6\' Storage Unit Graphic ',
        amenities: [
            { content: 'Chairs', },
            { content: 'Small Bookcases', },
            { content: 'Suitcases', },
    ...
    {
        size: '5\' x 12\' Storage Unit',
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/5x10.png',
        data: `This unit is approximately 30 sq feet of space that can hold the contents of one small closet, such as:`,
        alt: '5\' x 12\' Storage Unit Graphic ',
        amenities: [
            { content: 'Chairs', },
            { content: 'Small Desks', },
            { content: 'Small Bookcases', },
    ...
    },
    {
        ...
        img: 'https://s3.amazonaws.com/syrasoft-tenant-facing-websites/Syrasoft_Poweredby/unit-sizer/10x10.png',
        data: `This unit is approximately 60 sq feet of space that can hold the contents of one small room, such as:`,
        alt: '6\' x 10\' Storage Unit Graphic ',
        amenities: [
            { content: 'Chairs', },
            { content: 'Small Desks', },
            { content: 'Small Bookcases', },

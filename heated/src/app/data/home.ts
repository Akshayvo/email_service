...
export const aboutUs = [
    ...
    {
        p: `Since 2009, Heated Self Storage Inc. has served Orillia, Muskoka, Simcoe, and the surrounding communities with clean, well-maintained, and affordable self storage units and vehicle parking. Our facility is built from the ground up to ensure your next self storage project is fast and easy. Start by checking out our rates and availability, then use our simple contactless rental process. Once your electronic lease agreement is signed, you’ll receive your gate access code. Our extended hours from 6:00AM to 10:00PM every day let you come and go from our tidy self storage facility with full-sized loading bays on your schedule.`,
    },
    {
        p: `Our experienced and knowledgeable management team understands that selecting a self storage facility is about more than just a convenient location. The safety of our tenants and the security of their belongings is of the utmost importance to us. That’s why our facility is well-lit, covered by numerous security cameras, and is entirely fenced. Our staff also perform regular lot checks to ensure that you feel safe at all times when loading and unloading your unit.`,
    },
    {
...
Clear up some room around the house with heated Self Storage - North and one of our affordable storage units,

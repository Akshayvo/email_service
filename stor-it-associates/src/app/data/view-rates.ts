export const dataViewRates = [
    ...
    {
        p: `It doesn't matter if you're renovating your home, downsizing to smaller accommodations, or
        running a growing business; Store-It Associates has the ideal self storage,
        or parking solution for you!  Call to reserve your unit, today!`,
    }
];

export const viewRatesAltText = `photograph of outdoor parking at a storage facility`;

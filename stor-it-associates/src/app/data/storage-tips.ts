export const storagePoints = [
    ...
    { data: `We recommend putting boxes on pallets to keep belongings off of the concrete floors.  
             We have a limited supply available. Please speak to the manager for more details.`}
];

...
id = 3;
  ...
  constructor(
    ...
    this.imageBaseUrl = this.uaParserService.baseUrl;
      ...
      if (this.router.url.includes(`${environment.locationName}/units-107`)) {
            this.meta.addTag({
              name: 'description',
              content: `${this.location1PageContent}`
    });
    this.titleService.setTitle(`${this.location1PageTitle}`);
            this.locationName = `Units 1 - 107`;
    ...
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `Units 108 - 199`;
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/units-107/reserve-unit`],
          );
  } else if ( this.locationId === 2 ) {
    this.router.navigate([`${environment.locationName}/units-199/reserve-unit`],
          );

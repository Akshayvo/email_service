...
export const apiRoutes = [
    ...
    { path: `${environment.locationName}/units-107`,
    ...
    { path: `${environment.locationName}/units-199`,
      component: LocationComponent,
      children: [
        {path: '', redirectTo: 'storage-units', pathMatch: 'full' },
        { path: 'storage-units', component: ViewRatesComponent },
    ...
    { path: 'review/units-107', component: HomeComponent,
    resolve: {
  ...
  { path: 'review/units-199', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  {
    path: 'pay-rent/units-107', component: PayRentComponent,
    children: childroute
  },
  {
    path: 'pay-rent/units-199', component: PayRentComponent,
    children: childroute
  },
  {
  ...
  { path: 'contact-units-107', component: ContactUsComponent},
  { path: 'contact-units-199', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-units-107', component: PayRentFloridaComponent },
  { path: 'pay-rent-units-199', component: PayRentChesterComponent},

...
export class LocationComponent implements OnInit {
  ...
  constructor(
    ...
    this.imageBaseUrl = this.uaParserService.baseUrl;
      ...
      if (this.router.url.includes(`${environment.locationName}/montello`)) {
            this.meta.addTag({
              name: 'description',
              content: `${this.location1PageContent}`
    });
    this.titleService.setTitle(`${this.location1PageTitle}`);
            this.locationName = `MP&E Storage - Montello`;
    ...
    } else if (this.router.url.includes(`${environment.locationName}/wautoma`)) {
           this.meta.addTag({
             name: 'description',
             content: `${this.location2PageContent}`
    });
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `MP&E Storage - Wautoma`;
    ...
    this.titleService.setTitle(`${this.location3PageTitle}`);
        this.locationName = `MP&E Storage - Barnwell Location`;
    ...
    this.locationName = `MP&E Storage - Belforest Location`;
...
this.titleService.setTitle(`${this.location5PageTitle}`);
    this.locationName = `MP&E Storage - Fairhope`;
...
this.titleService.setTitle(`${this.location6PageTitle}`);
  this.locationName = `MP&E Storage - Robertsdale`;
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/montello/reserve-unit`],
          );
  } else if ( this.locationId === 2 ) {
    this.router.navigate([`${environment.locationName}/wautoma/reserve-unit`],
          );

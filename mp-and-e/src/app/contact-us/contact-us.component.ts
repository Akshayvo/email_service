...
export class ContactUsComponent implements OnInit {
  ...
  public fetchOg() {
    if (this.router.url.includes('montello')) {
...
public fetchTwitter() {
  ...
  public fetchContactDetailsLocation1() {
    this.heading = `MP&E Storage - Montello`;
    this.locationId = '1'
  ...
  public fetchContactDetailsLocation2() {
    this.locationId = '2'
    this.heading = `MP&E Storage - Wautoma`;
    this.contactDetails = contactsLocation2;
    this.hoursDetails = hoursLocation2;
  }

  public fetchContactDetailsLocation3() {
    this.heading = `MP&E Storage - Barnwell`;
    this.locationId = '3'
  ...
  public fetchContactDetailsLocation4() {
    this.heading = `MP&E Storage - Belforest`;
    this.locationId = '4'
  ...
  public fetchContactDetailsLocation5() {
    this.heading = `MP&E Storage - Fairhope`;
    this.locationId = '5'
  ...
  public fetchContactDetailsLocation6() {
    this.heading = `MP&E Storage - Robertsdale`;
    this.locationId = '6'

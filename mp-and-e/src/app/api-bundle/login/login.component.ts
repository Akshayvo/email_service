...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  public fetchContactDetail() {
    ...
    if (this.router.url.includes('montello')) {
      this.id = 1;
      this.name = 'MP&E Storage - Montello';
      ...
      this.id = 2;
      this.name = 'MP&E Storage - Wautoma';
      ...
      this.id = 3;
      this.name = 'MP&E Storage - Barnwell';
      ...
      this.id = 4;
      this.name = 'MP&E Storage - Belforest';
      ...
      this.id = 5;
      this.name = 'MP&E Storage - Fairhope';
      ...
      this.id = 6;
      this.name = 'MP&E Storage - Robertsdale';

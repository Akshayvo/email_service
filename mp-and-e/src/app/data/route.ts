...
export const apiRoutes = [
    ...
    { path: 'review/montello', component: HomeComponent,
    resolve: {
  ...
  { path: 'review/wautoma', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  {
    path: 'pay-rent/montello', component: PayRentComponent,
    children: childroute
  },
  {
    path: 'pay-rent/wautoma', component: PayRentComponent,
    children: childroute
  },
  {
  ...
  { path: 'contact-montello', component: ContactUsComponent},
  { path: 'contact-wautoma', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-montello', component: PayRentFloridaComponent },
  { path: 'pay-rent-wautoma', component: PayRentChesterComponent},

...
export class UnitSizerComponent implements OnInit {
  ...
  public fetchDetailsLocation1() {
    ...
    this.description = `Not sure what size unit you need for your belongings? Use our handy unit sizing guide to figure that out! Still have questions? Call (608) 577-3532!`;
  }

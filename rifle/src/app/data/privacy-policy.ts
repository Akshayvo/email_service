export const privacyPolicy = [
  {
    content: `This privacy notice discloses the privacy practices for www.riflestorageunits.com.
    ...
    note: `If you feel that we are not abiding by this privacy policy, you should contact us immediately
    via telephone at 970 665-9735 or info@riflestorageunits.com.`,
    registration: [
      {
    ...
    cookies: [
      ...
      },
      {
        content: [
          {
            p: `We use "cookies" on this site. A cookie is a piece of data stored on a site visitor's
            hard drive to help us improve your access to our site and identify repeat visitors to
            our site. For instance, when we use a cookie to identify you, you would not have to
            log in a password more than once, thereby saving time while on our site. Cookies can also

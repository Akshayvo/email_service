...
export const dataViewRates = [
    {
      p: `Thibodaux residents looking for a safe and secure storage solution, look no further!`,
    },
    {
      p: `Quality Storage is locally owned and operated, providing high-quality self storage services at an affordable price. Are you cleaning out that attic, garage, or basement? Maybe you're just preparing for a move or home renovation. We have a variety of unit sizes to choose from, so we can accommodate any storage space need you may have.`
    },
    {
      p: `Our well-maintained facility offers peace of mind that your belongings are in good hands. With ample security cameras and well-lit grounds, you can rest easy knowing Quality Storage takes security seriously. `
    },
    {
      p: `Give us a call today to rent your unit!`
    }
];

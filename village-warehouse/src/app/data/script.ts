...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/village_warehouse_inc/jpg/stock-self-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/village_warehouse_inc/jpg/stock-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/village_warehouse_inc/jpg/stock-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://g.page/VillageWarehouseStorage?share",
     description: "Village Warehouse Inc. is East Rochester’s one stop self storage solution providing a variety of indoor and temperature controlled self storage units conveniently located east of Lincoln Road on Ontario Street. We proudly serve residential and commercial customers in East Rochester, Fairport, Penfield, and the surrounding communities with affordable extra storage space and outdoor vehicle parking. ",

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Doc_Images/jpg/docs-hideaway-mini-storage-1.jpg', // 1:1
      'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Doc_Images/jpg/docs-hideaway-mini-storage.jpg', // 4:3
      'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Doc_Images/jpg/docs-hideaway-mini-storage.jpg' // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: 'https://g.page/Docshideaway?share',
     description: 'Are you in search of affordable self storage units near Oswego, NY? Oswego Self Storage has a wide variety of sizes and excellent customer service!',
     streetAddress: '10400 East 86th St N',
     state: 'Oklahoma',
     ...
     bestRating: '5',
     reviewCount: '11',
     latitude: 36.30026410043154,
     longitude: -95.85598451670299,
     openingHours: [],
     priceRange: '$65-$105'
};

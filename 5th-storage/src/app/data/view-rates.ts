...
export const dataViewRates = [
    {
      p: `5th Street Storage is the perfect solution for local residents and businesses looking to reclaim some space around the ! We offer a variety of storage unit sizes to fit your needs, and our well-maintained facility ensures your belongings will be safe and secure.
      `,
    },
    {
      p: `Our hometown service makes us the one-stop self storage solution in Bemidji. We provide high-quality, affordable storage services to meet your residential or business storage needs. Give us a call today to get started!`
    },

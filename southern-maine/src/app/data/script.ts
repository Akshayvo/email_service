...
import { homePageContent, homePageTitle, payRentPageTitle, payRentPageContent, storageTipsTitle, storageTipsContent, contactPageTitle, contactPageContent } from "./title";

...
const contactIndex = contact.findIndex(x => x.label === 'Business Hours:');
...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Herlihy/jpg/herlihy-moving-and-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Herlihy/jpg/herlihy-moving-and-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Herlihy/jpg/herlihy-moving-and-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/WNfE3oDkb4oZftqeA",
     description: "Herlihy Self Storage is Chillicothe's most trusted self storage facility and moving services company. Our 90 years of experience make us your one-stop self storage and moving stop. We offer a wide selection of self storage units with online rentals for quick and easy!",

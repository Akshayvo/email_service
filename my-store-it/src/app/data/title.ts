...
export const viewRatesPageContent = `Check out our affordable self storage unit rates and start the reservation process right here! Have a question? Call (734) 777-3711!`;

export const reservePageTitle = ``;
export const reservePageContent = ``;

export const payRentPageTitle = `Pay Rent  | My Store-It Space`;
...
export const thankYouPageTitle = `Thank You For Reserving Your Unit at My Store-It Space!`;
export const thankYouPageContent = `We've received your reservation! One of our friendly staff will be in touch!`;

export const privacyPolicyPageTitle = `Privacy Policy | My Store-It Space`;

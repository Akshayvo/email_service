export const  homePageTitle = `Affordable Self Storage in Lake Mills | Rock Lake Storage`;
export const homePageContent = `Rock Lake Storage serves Lake Mills and the surrounding communities with a variety of well-maintained and affordable self storage units.`;


export const viewRatesPageTitle = `View Rates  | Rock Lake Storage`;
...
export const reservePageTitle = `Reserve a Unit | Rock Lake Storage`;
...
export const contactPageTitle = `Contact Us  | Rock Lake Storage`;

...
export const headingLocation2 = `AllSpace Storage - Poughkeepsie/Hyde Park`;

export const headingLocation3 = `AllSpace Storage - Highland`;

export const headingLocation4 = `AllSpace Storage - Kingston/Lake Katrine`;

export const headingLocation5 = `AllSpace Storage - Pawling`;

export const headingReservePageLocation1 = `AllSpace Storage - Poughkeepsie/Arlington`;

export const headingReservePageLocation2 = `AllSpace Storage - Poughkeepsie/Hyde Park`;

export const headingReservePageLocation3 = `AllSpace Storage - Highland`;

export const headingReservePageLocation4 = `AllSpace Storage - Kingston/Lake Katrine`;

export const headingReservePageLocation5 = `AllSpace Storage - Pawling`;

export const heading1 = `AllSpace Storage - Poughkeepsie/Arlington`;

export const heading2 = `AllSpace Storage - Poughkeepsie/Hyde Park`;

export const heading3 = `AllSpace Storage - Highland`;

export const heading4 = `AllSpace Storage - Kingston/Lake Katrine`;

export const heading5 = `AllSpace Storage - Pawling`;
...
export const aboutUsHeadingLocation1 = `AllSpace Storage - Poughkeepsie/Arlington`;

export const aboutUsHeadingLocation2 = `AllSpace Storage - Poughkeepsie/Hyde Park`;

export const aboutUsHeadingLocation3 = `AllSpace Storage - Highland`;

export const aboutUsHeadingLocation4 = `AllSpace Storage - Kingston/Lake Katrine`;

export const aboutUsHeadingLocation5 = `AllSpace Storage - Pawling`;
...
// tslint:disable-next-line:max-line-length
export const aboutUsImageLocation3 = `https://s3.amazonaws.com/syrasoft-tenant-facing-websites/AllSpace_Images/Photos/NewPaltz-Highland/new-paltz-highland.jpg`;

// tslint:disable-next-line:max-line-length
export const aboutUsImageLocation4 = `https://s3.amazonaws.com/syrasoft-tenant-facing-websites/AllSpace_Images/Photos/Kingston-LakeKatrine/kingston-lake-katrine.jpg`;

// tslint:disable-next-line:max-line-length
export const aboutUsImageLocation5 = `https://s3.amazonaws.com/syrasoft-tenant-facing-websites/AllSpace_Images/Photos/Pawling-Brewster/pawling-brewster.jpg`;

// tslint:disable-next-line:max-line-length
export const aboutUsImageLocation2 = `https://s3.amazonaws.com/syrasoft-tenant-facing-websites/AllSpace_Images/Photos/Poughkeepsie-HydePark/poughkeepsie-hydepark.jpg`;

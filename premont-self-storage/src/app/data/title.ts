...
export const payRentPageTitle = `Pay Rent  | Premont Self Storage`;
...
export const storageTipsTitle = `Storage Tips  | Premont Self Storage`;
export const storageTipsContent = `Follow these easy self storage tips to make your stay with Premont Self Storage a breeze! Have questions? Call today!`;

export const unitSizerPageTitle = `Unit Sizer  | Premont Self Storage`;
export const unitSizerPageContent = `Are you not sure what size unit you require? Use this guide to help you figure out what fits inside the units offered at Premont Self Storage!`;

export const contactPageTitle = `Contact Us  | Premont Self Storage`;
...
export const thankYouPageTitle = `Thank You For Reserving Your Unit at Premont Self Storage`;

...
export class UnitSizerComponent implements OnInit {
  ...
  public fetchDetailsLocation1() {
    ...
    this.description = `Take a moment to review our unit sizer to learn what will fit into the variety of units we have at R & R Self Storage's Confederate Way location.`;
  }

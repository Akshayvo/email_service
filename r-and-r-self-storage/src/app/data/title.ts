export const homePageTitle = `Affordable Self Storage Units in Jasper, Georgia`;
export const homePageContent = `Check out our 6 facilities conveniently located in and around Jasper, Georgia! Rent or reserve your unit online in seconds!`;
...
export const payRentPageTitle = `Pay Rent | R&R Self Storage`;
...
export const storageTipsTitle = `Storage Tips  | R & R Self Storage`;
export const storageTipsContent = `Follow these easy self storage tips to make your stay with R & R Self Storage a breeze! Have questions? Call today!`;

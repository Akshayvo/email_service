...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Roth_Self_Storage/jpg/roth-self-storage-large-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Roth_Self_Storage/jpg/roth-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Roth_Self_Storage/jpg/roth-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://g.page/RothSelfStorageOmaha?share",
     description: "Roth Self Storage South Omaha’s one stop storage solution for clean, well-maintained, and affordable storage unit space. We are conveniently located on 44th South in South Omaha and serve residents and businesses in the surrounding communities with quality and affordable self storage services. ",

...
export class UaParserService {
  ...
  determineBaseUrl() {
   ...
   this.baseUrl = `https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Roth_Self_Storage/webp`;
    } else {
    this.baseUrl = 'https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Roth_Self_Storage/jpg';
    }
  }
}

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
     ...
     description: "Cedar Rapids residents – looking for a safe, secure place to store your belongings? Look no further than Extra Storage! Our facility is well-maintained and our rates are highly affordable – you won’t find a better deal anywhere else. Plus, we offer convenient 24/7 access so you can get to your belongings when you need them.",

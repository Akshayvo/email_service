...
export const dataViewRates = [
    {
      p: `We offer a variety of storage unit sizes, so you can find the perfect fit for your needs. Plus, our facility is well-maintained and well-lit with ample security cameras and regular lot inspections.`,
    },
    {
      p: `Our convenient location makes it easy for you to access your belongings whenever you need them. Plus, our affordable rates make self storage more affordable than ever before.`
    },
    {
      p: `Reserve or rent online today!`
    },
];

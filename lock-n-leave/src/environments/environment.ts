...
export const environment = {
  ...
  locationName: 'new-york/harpursville', // state/city  **Remeber to update locationName in sitemap.xml as well
  ...
  APIKey: `dzJ0OVc0SjgqNU46MjJ8JTg3ODc3JCg4PWJXMHNoZGQ5a2VvY15O`, // demo north 28463
};

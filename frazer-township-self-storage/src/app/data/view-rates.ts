...
export const dataViewRates = [
    {
      p: `Frazer Township Self Storage has all of the modern conveniences to make your next self storage project a fast and easy one. Our facility is conveniently located on a quiet road for easy access with car, truck, or moving van for easy loading and unloading. We cater to a variety of storage self storage customers from residential to commercial and local non-profit organizations.`,
    },
    {

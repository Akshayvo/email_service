...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
     ...
     description: "Frazer Township Self Storage is Tarentum's newest self storage facility! Our facility is conveniently located on Butler Logan road, and we offer a number of self storage unit that are sure to meet your storage needs. From moves to renovations or downsizing, Frazer Township Self Storage is your one stop storage solution!",
     streetAddress: "2102 Butler Logan Rd",
     state: "Pennsylvania",
     ...
     openingHours: [],
     priceRange: '120 (only 1 unit type)'
};

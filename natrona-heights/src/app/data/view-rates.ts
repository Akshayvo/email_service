export const dataViewRates = [
    {
      p: `Natrona Heights Self Storage is your one-stop-self-storage-stop! Our conveniently located self
          storage facility is next to the Pine Ridge Apartments, behind the V.F.W. on Veterans Drive, off
          of Freeport Road. We offer a wide variety of self storage unit sizes, and they come in regular
          and temperature-controlled types!`,
    },
    {

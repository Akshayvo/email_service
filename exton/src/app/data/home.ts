...
export const featuresList = [
    {
        td1: 'Family-Owned',
        td2: 'Daily Office Hours',
    },
    {
        td1: 'Convenient Location',
        td2: 'Self-Service Paper Shredding',
    },
    {
    ...
    {
        td1: 'Pin-Code Activated Gates',
        td2: 'Online Payments',
    },
    {
        td1: 'Automatic Payments Available',
...
export const feature = [
    {
        ...
        path: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Exton_Store/location.svg',
        label: 'Conveniently Located',
        alt: 'Icon art displaying a location pin'
    },
    {
        // tslint:disable-next-line:max-line-length
        path: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Exton_Store/garage.svg',
        label: 'Boat and Vehicle Storage',
        alt: 'Icon art displaying boat and motorcycle'
    },
    {
        // tslint:disable-next-line:max-line-length
        path: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Exton_Store/light-bulb.svg',
        label: 'Well-Lit Facility',
        alt: 'Icon of an illuminated light'
    },
    {
        // tslint:disable-next-line:max-line-length
        path: 'https://syrasoft-tenant-facing-websites.s3.amazonaws.com/Exton_Store/fence.svg',

...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Windmill_self_storage/windmill-self-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Windmill_self_storage/windmill-self-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Windmill_self_storage/windmill-self-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/V1GkHWmvMyFvEQRo9",
     description: "Windmill Self Storage is locally owned and operated self storage facility centrally located in Lecanto, Florida. We are proud to serve our friends and neighbors in Lecanto, Inverness, Citrus Hills, and the surrounding communities with friendly customer service, and quality self storage units at very affordable rates. Windmill Self Storage is located conveniently on FL-44, just East of County Road 491. Just look for the big yellow windmill! You can’t miss us!",

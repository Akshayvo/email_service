...
export const dataViewRates = [
    {
      p: `Take a moment to check out our pricing and availability, then give our office a call to speak with one of our friendly managers. Still have questions? Give us a call today! We look forward to making your next storage project a convenient and affordable one.`,
    },

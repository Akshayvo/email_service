export const homePageTitle = `Affordable Self Storage & Vehicle Parking in Owasso, OK`;
export const homePageContent = `Elm Creek Mini Storage serves Owasso and the surrounding communities with a variety of well-maintained and affordable self storage units`;
...
export const storageTipsTitle = `Storage Tips  | Elm Creek Mini Storage`;
export const storageTipsContent = `Follow these easy self storage tips to make your stay with Elm Creek Mini Storage a breeze! Have questions? Call (918) 272-8894 today!`;

export const unitSizerPageTitle = `Unit Sizer  | Elm Creek Mini Storage`;
export const unitSizerPageContent = `Are you not sure what size unit you require? Use this guide to help you figure out what fits inside the units offered at Elm Creek Mini Storage!`;

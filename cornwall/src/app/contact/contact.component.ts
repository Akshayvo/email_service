...
export class ContactComponent implements OnInit {
  ...
  constructor(
    ...
    this.meta.addTag({
      name: 'description',
      content: `Have a question about the services offered by Cornwall Storage Box? Use our handy
      contact form on this page or call (613) 932-0480`
    });
    this.titleService.setTitle('Contact Us | Cornwall Storage Box');

...
export const directionLocation1 = [
    ...
    },
    {
        ...
        { content: 'Take exit 45 for I-490 toward Rochester/Your - 0.6 mi' },
...
export const directionLocation3 = [
    ...
    {
        label: 'Driving directions to Your Self Storage coming from Route 84 exit 5A',
        datas: [
    ...
    {
        label: 'Driving directions to Your Self Storage driving North on Route 208',
        datas: [
        { content: 'Pass under Route 84 going North on Route 208.'},
        { content: 'Turn right onto Bracken Rd 0.8 Miles.' },
        { content: 'Your Self Storage will be on the right hand side of the road.' }
        ],
    }
] ;

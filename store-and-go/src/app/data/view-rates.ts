export const viewRates = [
  {
	...
	{
		p: `Our facility is fully-fenced, and well-lit, with ample room for all of your belongings, be they household
		items, tools, vehicles, or business equipment. We look forward to making your self storage experience an
		enjoyable one! Call or reserve online, today!`
	}
];

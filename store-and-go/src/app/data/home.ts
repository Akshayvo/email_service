...
export const aboutUs = [
    ...
    {
        p: `We offer a number of outdoor enclosed storage unit options from our large closet-sized 5-foot
        by 5-foot units, to our room-sized 10-foot by 10-foot units. We also have parking for boats,

...
export const storageTips = [
  ...
  },
  {
    ...
    contents: [
      ...
      {
        data: "Layer wrapped items in sturdy cardboard boxes or plastic storage totes separated by large styrofoam packing peanuts or wadded paper between items.",
      },
      {

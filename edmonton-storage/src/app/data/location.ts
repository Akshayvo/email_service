...
export const location1AmenitiesHeading = `Amenities`;

export const location2AmenitiesHeading = `Amenities`;

export const location1AmenitiesParagraph = `24/7 Access for clients in good standing – please ask for details.`;

export const location2AmenitiesParagraph = `24/7 Access for clients in good standing – please ask for details.`;

export const location1FeaturesList = [
    {
        td1: 'Video Monitoring',
        td2: 'Keypad Controlled Gate'
    },
    {
    ...
    {
        td1: 'Competitive Rates',
        td2: 'Packing Supplies'
    },
];

export const location2FeaturesList = [
    {
        td1: 'Video Monitoring',
        td2: 'Well-Lit Facility'
    },
    {
        td1: 'Keypad Controlled Gate ',
        td2: 'Fully-Fenced Facility'
    },
    {
        td1: 'Experienced Management',
        td2: 'Competitive Rates'
    },
    {
        td1: 'Vehicle Storage',
        td2: 'Packing Supplies'

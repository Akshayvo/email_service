export const homePageTitle = `Climate Controlled & Regular Storage Units in Verona, WI`;
export const homePageContent = `Madison Verona Self Storage offers convenient 24/7 access to your belongings, online payments, and a variety of unit sizes for all of your self storage needs.`;

export const viewRatesPageTitle = `View Rates  | Madison Verona Self Storage`;
export const viewRatesPageContent = `Take a moment to view our affordable self storage unit rates, then rent your unit by filling out our form or calling our office today!`;

export const reservePageTitle = ``;
export const reservePageContent = ``;

export const payRentPageTitle = `Pay Rent  | Madison Verona Self Storage`;
...
export const thankYouPageTitle = `Thank You For Reserving Your Unit at Madison Verona Self Storage`;
export const thankYouPageContent = `We've received your reservation! One of our friendly staff will be in touch!`;

export const privacyPolicyPageTitle = `Privacy Policy | Madison Verona Self Storage`;

...
export class ContactComponent implements OnInit {
  ...
  constructor(
    ...
    this.meta.addTag({
      name: 'description',
      content: `Have a question about our services or your account with Storage World Mobile?
      Use our form or call (763) 434-4645 today!`
    });
    this.titleService.setTitle('Contact Us | Storage World Mobile');

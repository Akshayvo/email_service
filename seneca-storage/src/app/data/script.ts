...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Seneca_Storage/jpg/seneca-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Seneca_Storage/jpg/seneca-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Seneca_Storage/jpg/seneca-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/63iRvweA3cAUGHMj8",
     description: "Seneca Storage is Seneca, Pennsylvania's one stop self storage solution. We pride ourselves on our well-maintained, clean, affordable storage units backed by the amazing customer service that only a locally owned and operated business can provide. ",
     streetAddress: "2326, 3008 PA-257,",
     state: "Pennsylvania",

export const dataViewRates = [
    ...
    {
        p: `We are an excellent solution for the business in need of that little extra space.
            Our units and parking spaces can be accessed from 6:00AM to 11:00PM so you are free
            to work around your schedule not just the standard business hours!`,
    },
];

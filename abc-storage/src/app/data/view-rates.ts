...
export const dataViewRates = [
    ...
    {
      p: `The possibilities are basically endless. The one common thing with all these different situations is that they are a time of change and uncertainty in people’s lives. We know that this can be stressful, and that’s why we take so much pride in what we do. By providing clean and secure storage solutions, as well as friendly and helpful service, we can give people a bit of peace of mind during a stressful period of their lives.
      `
    }

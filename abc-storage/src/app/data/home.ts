...
export const aboutUs = [
    {
        p: `ABC Storage is a self-storage facility centrally located in Kingston, Ontario, Canada, one minute north of Highway 401 and only 10 minutes from downtown Kingston. There are many available units, ranging in size from 5' x 5' to 10' x 20'. All self-storage units are clean, dry and secure.`,
    },
    {

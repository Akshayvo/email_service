...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Chal-A/Jpg/chal-a-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Chal-A/Jpg/chal-a-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Chal-A/Jpg/chal-a-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://g.page/chal-a-apartments-storage?share",
     description: "Chal-A Apartments and Climate Controlled Storage is Sturgeon Bay’s premier self storage solution. We are conveniently located on WI-57 just north of Egg Harbor Rd. Our climate controlled self storage facility offers a variety of storage unit sizes that are ideal for any self storage needs from preparing for a move to stowing your work site equipment safely away from the elements. Our climate controlled self storage units range from 6-foot-by-6-foot storage units all the way up to our extra large10-foot-by-18-foot.",

...
export const dataViewRates = [
    {
      p: `Take a moment to check out our availability and unit rates, then submit your application through our website. 
      You’ll receive an electronically signable lease in just a few moments. Once you’ve signed, 
      your gate access code will be emailed to you. `,
    },
    {
      p: `When you arrive, you’ll find a well-kept climate controlled self storage facility complete with security 
      cameras and well-lit aisles to ensure a sense of safety at all times. Our on-site management team is here 
      to help you get settled in. Still have questions? Give us a call today!`
    },
];

...
export const dataViewRates = [
  {
    p: `Our customers range from homeowners, and renters with furniture, tools, and seasonal decorations,
        to growing businesses searching for document, equipment, or inventory storage. Our lease terms are
        easy, and the rates are affordable.`,
  },
  {
    p: `Whether you're just in the need for an extra closet's worth of storage, or need to house inventory,
        and equipment while avoiding commercial real estate rates, Acorn Self Storage has a unit for you!`
  }
];

export const viewRatesAltText = `self storage units with paved parking in front of them`;

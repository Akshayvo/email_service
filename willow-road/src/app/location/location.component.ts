...
import { heading1, heading2, tabs,   } from '../data/location';
import { Title, Meta } from '@angular/platform-browser';
import { WINDOW } from '@ng-toolkit/universal';
import { DataSharingService } from '../api-bundle/services/data-sharing.service';
import { CanonicalService } from '../services/canonical.service';
import { Location1Script,ogLocation1, twitterLocation1,
  Location2Script,ogLocation2, twitterLocation2,
   } from '../data/script';
...
export class LocationComponent implements OnInit {
  ...
  constructor(
    ...
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `Vista Dr Location - Willow Road Self Storage`;

...
import { contactPageLocation1Script, ogContactPage, ogContactPageLocation1,
  twitterContactPage, twitterContactPageLocation1,
  contactPageLocation2Script, ogContactPageLocation2, twitterContactPageLocation2, } from '../data/script';
...
public fetchTwitter() {
  ...
  public fetchContactDetailsLocation2() {
    this.locationId = '2'
    this.heading = `Vista Dr Location - Willow Road Self Storage`;

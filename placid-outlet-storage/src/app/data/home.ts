...
export const aboutUsAlt = `a row of self storage units with a blue metal self storage door open to reveal a unit filled with personal belongings`;

export const aboutUsHeading = `Affordable Self Storage & Vehicle Parking in Lake Placid`;

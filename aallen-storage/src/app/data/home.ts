...
export const aboutUs = [
    ...
    {
        p: `Whether you utilize our full-service website or our 24/7 on-site kiosk, you can rent or reserve your storage space at your convenience. You’ll have 24-hour access to a secure, well-lit, high-tech, self storage facility, and you will be able to pay online or through our kiosk 24-hours a day.`,
    },
    {
        p: `We understand the need for self-storage. That is why we strive to provide all of the modern conveniences that make self-storage projects fast and easy. You can start the contactless rental process by viewing our available storage units, and renting or reserving your unit on our website. Once the rental process complete, you will have 24-hour access to a secure, well-lit, clean, and well-maintained self-storage unit. You will rest easy knowing our facility is covered by strategically placed security cameras.`,
    },
    {
        p: `Prefer doing business on-site? Our 24-hour, on-site customer service kiosk can complete the rental of new or additional storage units in minutes. It can also accept cash, check, or credit card payments 24-hours a day. So whether you are someone preparing for a move, a college student in search of summer storage, or you are growing a business that needs a little extra elbow room, Aallen Self Storage has you covered!`,
    },
    {

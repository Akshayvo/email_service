...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Airport_Area_Storage/jpg/airport-area-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Airport_Area_Storage/jpg/airport-area-storage-11.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Airport_Area_Storage/jpg/airport-area-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/RzbggsDvFwnykc6w7",
     description: "Airport Area Storage is your one-stop self storage stop with afully-fenced, well-lit facility has 24/7 access via an electronic pin-code activated gate, a full online tenant portal for 24/7 account access, and a management team dedicated to providing the best storage experience possible.",
     streetAddress: "4527 US-51 Suite B",
     state: "Wisconsin",

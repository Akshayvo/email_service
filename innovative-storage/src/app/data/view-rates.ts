...
export const dataViewRates = [
  {
    p: `Innovative Storage is Marion’s favorite locally owned and operated self storage facility. Our range of storage unit sizes are located on Innovative Drive in Marion, just a short drive from the Route 23 onramp. Our locally owned and operated self storage facility serves Marion and the surrounding communities with quality self storage space and friendly customer service at competitive rates!`,
  },
  {
    p: `Take a moment to review our availability, then rent your unit online in minutes with our easy online application. Still have questions? Give our friendly team a call! We can’t wait to meet you!`
  }
];

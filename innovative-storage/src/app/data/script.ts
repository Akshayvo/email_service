...
export const script = {               // Please fill this script according to facility's information
    imagesHomePage: [
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Innovative_Storage/jpg/innovative-storage-11.jpg", // 1:1
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Innovative_Storage/jpg/innovative-storage-43.jpg", // 4:3
      "https://syrasoft-tenant-facing-websites.s3.us-east-1.amazonaws.com/Innovative_Storage/jpg/innovative-storage-169.jpg" // 16:9
     ],
     telephone: contact[contactIndex].data,
     map: "https://goo.gl/maps/BTGaRidE835t8gna7",
     description: "Innovative Storage is Marion’s favorite locally owned and operated self storage facility. Our wide variety of unit sizes are conveniently located on Innovative Drive, only a  stone’s throw away from Route 23. Our facility was built from the ground up with modern conveniences and security features to make your stay with us an enjoyable experience!",
     streetAddress: "2271 Pageland Hwy",
     state: "innovative",
     addressLocality: "innovative",
     addressRegion: "SC",
     postalCode: "29720",
     addressCountry: "US",
     id: environment.websiteUrl || "https://marionstorageunits.com/",
     ...
     reviewCount: "9",
     latitude: 40.6081555,
     longitude: -83.0707996,
     openingHours: ["Su-Fr 00:00-24:00"],
     priceRange: '$52.50-$107.50'
};

...
import {
  ...
  accessHoursLocation4,
  accessHoursLocation5,
  accessHoursLocation6,
  accessHoursLocation7,
  accessHoursLocation8,
  accessHoursLocation9,
  accessHoursLocation10,
  accessHoursLocation11,
  accessHoursLocation12,
  contactsLocation1,
  contactsLocation2,
  contactsLocation3,
  contactsLocation4,
...
import {
  ...
  location6PageTitle,
  location7PageContent,
  location7PageTitle,
  location8PageContent,
  location8PageTitle,
  location9PageContent,
  location9PageTitle,
  location10PageContent,
  location10PageTitle,
  location11PageContent,
  location11PageTitle,
  location12PageContent,
  location12PageTitle,
} from "../data/title";
...
export class LocationComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.router.url.includes(`${environment.locationName}/evanston-ave`)) {
      ...
      this.router.url.includes(`${environment.locationName}/red-barn`)
    ) {
      this.meta.addTag({
        name: "description",
      ...
      this.router.url.includes(`${environment.locationName}/wayland-westside`)
    ) {
      this.meta.addTag({
        name: "description",
      ...
      this.router.url.includes(`${environment.locationName}/wayland-mill`)
    ) {
      this.meta.addTag({
        name: "description",
      ...
      this.dataSharingService.apiKey =
        this.dataSharingService.locationAPIKey.loc7;
      this.dataSharingService.locationName = this.locationName;
      ...
      this.router.url.includes(`${environment.locationName}/wayland-southside`)
    ) {
      this.meta.addTag({
        name: "description",
      ...
      this.dataSharingService.apiKey =
        this.dataSharingService.locationAPIKey.loc8;
      this.dataSharingService.locationName = this.locationName;
      ...
      this.dataSharingService.apiKey =
        this.dataSharingService.locationAPIKey.loc9;
      this.dataSharingService.locationName = this.locationName;
      ...
      this.dataSharingService.apiKey =
        this.dataSharingService.locationAPIKey.loc10;
      this.dataSharingService.locationName = this.locationName;
      ...
      this.dataSharingService.apiKey =
        this.dataSharingService.locationAPIKey.loc11;
      this.dataSharingService.locationName = this.locationName;
      ...
      this.router.url.includes(`${environment.locationName}/allendale`)
    ) {
      this.meta.addTag({
        name: "description",
      ...
      this.dataSharingService.apiKey =
        this.dataSharingService.locationAPIKey.loc12;
      this.dataSharingService.locationName = this.locationName;

export const faq = [
  {
    ...
    paragraph: `Redi Storage - Windham is located inside the former Dollar General store, located off North Main Street in Windham, OH.  All of our units are climate-controlled, and each unit is individually alarmed to provide enhanced security for your belongings being stored with us.  By using our easy-to-use online rentals, you can begin moving into your new, secure, and clean unit in a matter of minutes!`,
  },
  {
  ...
  },
  {
    ...
    paragraph: `Give written notice at least ten days prior to vacating, remove all items from the unit, leave unit broom-clean, inform Redi Storage staff via phone or email at 833-900-7334 or windham@redistorage.com. Vacate notices need to include the mailing address for the security deposit to be returned to.`,
  },
  {
    h2: `What are my payment options?`,
    paragraph: `Online payments via credit or debit card, Auto-pay, contacting our facility managers via phone or email at 833-900-7334 x110 or Windham@RediStorage.com, and lastly by mailing a check or money order to our corporate office at 10121 Northfield Rd, Northfield, OH 44067. Check/Money Order payments should include the facility name and unit number to ensure it's applied to the correct account.`,
  ...
  },
  {
    ...
    paragraph: `We do not offer any moving carts or dollies.`,
  },
  {

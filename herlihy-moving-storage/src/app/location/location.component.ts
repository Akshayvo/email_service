...
import { contactLocationPage1, hoursLocation1, hoursLocation1AcessHours,
          contactLocationPage2, hoursLocation2,hoursLocation2AcessHours,
          } from '../data/contact';
...
export class LocationComponent implements OnInit {
 ...
 public navigateToReserve() {
  if ( this.locationId === 1 ) {
    this.router.navigate([`${environment.locationName}/chillicothe/reserve-unit`],
          );
  } else if ( this.locationId === 2 ) {
    this.router.navigate([`${environment.locationName}/grove-city/reserve-unit`],
          );
  }  

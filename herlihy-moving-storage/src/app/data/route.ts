...
export const apiRoutes = [
    ...
    { path: 'review/chillicothe', component: HomeComponent,
    resolve: {
  ...
  { path: 'review/grove-city', component: HomeComponent,
    resolve: {
        url: 'externalUrlRedirectResolver'
    },
    data: {
  ...
  {
    path: 'pay-rent/chillicothe', component: PayRentComponent,
    children: childroute
  },
  {
    path: 'pay-rent/grove-city', component: PayRentComponent,
    children: childroute
  },
  {
  ...
  { path: 'contact-chillicothe', component: ContactUsComponent},
  { path: 'contact-grove-city', component: ContactUsComponent},
...
export const iFrameRoutes = [
  ...
  { path: 'pay-rent-chillicothe', component: PayRentFloridaComponent },
  { path: 'pay-rent-grove-city', component: PayRentChesterComponent},

...
export class LocationComponent implements OnInit {
  ...
  constructor(
    ...
    this.titleService.setTitle(`${this.location2PageTitle}`);
           this.locationName = `Success Property Management - Silverhill`;
    ...
    this.titleService.setTitle(`${this.location3PageTitle}`);
        this.locationName = `Success Property Management - Barnwell Location`;
    ...
    this.locationName = `Success Property Management - Belforest Location`;
...
this.titleService.setTitle(`${this.location5PageTitle}`);
    this.locationName = `Success Property Management - Fairhope`;
...
this.titleService.setTitle(`${this.location6PageTitle}`);
  this.locationName = `Success Property Management - Robertsdale`;
